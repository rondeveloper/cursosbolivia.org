                    ...
                    <form id="form-agrega-participante" name="form_add_participante">
                        <table class="table" style="background:#dadada;border-radius:5px;padding-bottom: 0px;">
                            ...
                            <tr>
                                ...
                                <td style="width: 27%;"><input type="text" name="nombres" class="form-control" placeholder="Nombres" id="f-nom" required=""/></td>
                                <td style="width: 27%;"><input type="text" name="apellidos" class="form-control" placeholder="Apellidos" id="f-ape" required=""/></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="nit" class="form-control" placeholder="NIT" id="f-nit"/></td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="correo" class="form-control" placeholder="Correo electr&oacute;nico" /></td>
                                <td colspan="2">
                                    <input type="text" name="observaciones" class="form-control" placeholder="Observaciones..." />
                                </td>
                                <td>
                                    <b onclick="nombreFact(1);" class="btn btn-xs btn-default"><i class="fa fa-star"></i> NF1</b>
                                    &nbsp;
                                    <b onclick="nombreFact(2);" class="btn btn-xs btn-default"><i class="fa fa-star"></i> NF2</b>
                                    &nbsp;
                                    <b onclick="nombreFact(3);" class="btn btn-xs btn-default"><i class="fa fa-star"></i> NF3</b>
                                    <br/>
                                    <b onclick="nitFact(3);" class="btn btn-xs btn-default"><i class="fa fa-star"></i> CiNit</b>
                                    &nbsp;&nbsp;
                                    <label for="impficha">
