...
<div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="col-md-8" style="padding:0px;">
                                        <input type="text" name="ci" class="form-control" placeholder="C.I." id="f-ci" autocomplete="off"/>
                                    </div>
    ...
    <!--                                    <input type="number" name="monto_pago" class="form-control" placeholder="Monto..." required="" value="<?php echo $costo_curso; ?>"/>-->
                                ...
                                <div class="col-md-3"><input type="text" name="razon_social" class="form-control" placeholder="Razon Social" id="f-raz" autocomplete="off"/></div>
                                <div class="col-md-3"><input type="text" name="nit" class="form-control" placeholder="NIT" id="f-nit" autocomplete="off"/></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <input type="text" name="correo" class="form-control" placeholder="Correo electr&oacute;nico..." autocomplete="off"/>
                                </div>
                                <div class="col-md-3">
...
<script>
    function generar_reporte(formato) {
        ...
        var data_required = 'data_report_nombres=' + data_report_nombres + '&data_report_apellidos=' + data_report_apellidos + '&data_report_datosfacturacion=' + data_report_datosfacturacion + '&data_report_datoscontacto=' + data_report_datoscontacto + '&data_report_firma=' + data_report_firma + '&data_report_prefijo=' + data_report_prefijo + '&data_report_fecharegistro=' + data_report_fecharegistro + '&data_report_modoregistro=' + data_report_modoregistro + '&data_report_eliminados=' + data_report_eliminados + '&data_numeracion_certificado=' + data_numeracion_certificado + '&data_id_turno=' + data_id_turno;

        window.open('http://www.cursos.bo/contenido/paginas.admin/ajax/ajax.impresion.cursos-participantes.exportar-lista.php?id_curso=<?php echo $id_curso; ?>&' + formato + '=true&' + data_required, 'popup', 'width=700,height=500');
...
<script>
    var text__loading_uno = "<div style='text-align:center;'><img src='https://datainflow.com/wp-content/uploads/2017/09/loader.gif'/></div>";
