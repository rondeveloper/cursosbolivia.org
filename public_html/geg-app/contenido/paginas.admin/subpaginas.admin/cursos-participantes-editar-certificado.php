...
$certificado = mysql_fetch_array($recp1);
                    ...
                    <table style="margin:auto;width:70%;">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <a onclick="window.open('http://www.infosicoes.com/contenido/librerias/fpdf/tutorial/certificado-2.php?id_certificado=<?php echo $certificado_id; ?>', 'popup', 'width=700,height=500');" class="btn btn-xs btn-warning">CERTIFICADO</a>
