                ...
                <table class="table users-table table-condensed table-hover">
                        ...
                        <div id="MODAL-facturacion-registro-<?php echo $participante['id']; ?>" class="modal fade" role="dialog">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        <h4 class="modal-title">DATOS DE REGISTROrrr</h4>
                                    </div>
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-6 text-left">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            &nbsp;&nbsp;&nbsp; 
                            <a class="btn btn-xs btn-default" onclick="imprimir_certificados();"> <i class="fa fa-print"></i> Imprimir seleccionados </a> 
                            <br/>
                            <br/>
                            <input type="checkbox" checked="" disabled=""/>
                            &nbsp;&nbsp;&nbsp; 
                            <a class="btn btn-xs btn-default" onclick="alert('Funcion no disponible');"> <i class="fa fa-send"></i> Emitir seleccionados </a>
                            <br/>
                        </td>
                    </tr>
                    </tbody>
