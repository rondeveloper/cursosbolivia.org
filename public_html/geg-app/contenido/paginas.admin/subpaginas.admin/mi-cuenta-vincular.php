                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="https://cursos.bo/contenido/librerias/facebook-login/fbconfig.php">
                                        Facebook
                                    </a>
                                </td>
                                <?php
                                if ($fb_id !== '') {
                                    ...
                                    <td>
                                        <a href="https://cursos.bo/contenido/librerias/facebook-login/fbconfig.php" class="btn btn-xs btn-warning active">
                                            VINCULAR CUENTA
                                        </a>
                                    </td>
                                    <?php
