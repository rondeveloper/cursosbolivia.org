    ...
    <div class="col-mod-12">
        ...
        <form action="" method="post" onsubmit="return busca_participantes(<?php echo $id_curso; ?>, <?php echo $id_turno_curso; ?>, document.getElementById('inputbuscador').value);">
            <div class="input-group col-sm-12">
                ...
                <input type="text" name="input-buscador" value="" id="inputbuscador" class="form-control" placeholder="Nombres / Apellidos / Celular / Correo ..."/>
            </div>
        </form>
    </div>
</div>
    ...
    <div class="col-md-12NOT">
        <div class="panelNOT">
            ...
            if ($sw_habilitacion_procesos) {
                ...
                <div class="panel-bodyNOT" style="padding-bottom: 0px;padding-top: 0px;">
                    <form id="form-agrega-participante" name="form_add_participante">
                        <div class="panel-body" style="background:#dadada;border-radius:5px;padding-bottom: 0px;">
                            <input type='hidden' name='id_curso' value='<?php echo $id_curso; ?>'/>
                            <div class="row">
                                <div class="col-md-1 text-right"><input type="text" name="prefijo" class="form-control" placeholder="Sr. / Dr. / Arq. / Ing. " /></div>
                                <div class="col-md-3"><input type="text" name="nombres" class="form-control" placeholder="Nombres" id="f-nom" required=""/></div>
                                <div class="col-md-3"><input type="text" name="apellidos" class="form-control" placeholder="Apellidos" id="f-ape" required=""/></div>
                                <div class="col-md-3">
                                    <div class="col-md-8" style="padding:0px;">
                                        <input type="text" name="ci" class="form-control" placeholder="C.I." id="f-ci"/>
                                    </div>
                                ...
                                <div class="col-md-2"><b class="btn btn-success active" onclick="agrega_participante();"><i class="fa fa-plus"></i> Add participante</b></div>
                            </div>
                            <div class="row">
                                <div class="col-md-1 text-right"><input type="number" name="monto_pago" class="form-control" placeholder="Monto..." required="" value="<?php echo $costo_curso; ?>"/></div>
                                <div class="col-md-3"><input type="text" name="razon_social" class="form-control" placeholder="Razon Social" id="f-raz" /></div>
                                <div class="col-md-3"><input type="text" name="nit" class="form-control" placeholder="NIT" id="f-nit"/></div>
                                <div class="col-md-3"><input type="text" name="celular" class="form-control" placeholder="Celular" /></div>
                                <div class="col-md-2">
                                    <?php
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3"><input type="text" name="correo" class="form-control" placeholder="Correo electr&oacute;nico" /></div>
                                <div class="col-md-6">
                                    <input type="text" name="observaciones" class="form-control" placeholder="Observaciones..." />
                                </div>
                                <div class="col-md-2">
                                    <b onclick="nombreFact(1);" class="btn btn-xs btn-default">NF1</b>
                                    &nbsp;
                                    <b onclick="nombreFact(2);" class="btn btn-xs btn-default">NF2</b>
                                    &nbsp;
                                    <b onclick="nombreFact(3);" class="btn btn-xs btn-default">NF3</b>
                                    <br/>
                                    <b onclick="nitFact(3);" class="btn btn-xs btn-default">CiNit</b>
                                    &nbsp;&nbsp;
                                    <label for="impficha">
                ...
                <script>
                    function nombreFact(dat) {
                        ...
                        document.getElementById("f-raz").value = nfact;
                    }
                    function nitFact() {
...
<script>
    function generar_reporte(formato) {
        ...
        var data_required = 'data_report_nombres=' + data_report_nombres + '&data_report_apellidos=' + data_report_apellidos + '&data_report_datosfacturacion=' + data_report_datosfacturacion + '&data_report_datoscontacto=' + data_report_datoscontacto + '&data_report_firma=' + data_report_firma + '&data_report_prefijo=' + data_report_prefijo + '&data_report_fecharegistro=' + data_report_fecharegistro + '&data_report_modoregistro=' + data_report_modoregistro + '&data_report_eliminados=' + data_report_eliminados + '&data_id_turno=' + data_id_turno;
...
<script>
    ...
    function busca_participantes(id_curso, id_turno, busc) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-participantes.lista_participantes.php',
            data: {id_curso: id_curso, id_turno: id_turno, busc: busc},
            type: 'POST',
            dataType: 'html',
            success: function (data) {
                $("#ajaxloading-lista_participantes").html("");
