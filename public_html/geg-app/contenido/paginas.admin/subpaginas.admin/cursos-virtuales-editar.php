...
if (isset_post('editar-pagina-principal')) {
    ...
    /*
    $video_introductorio_name = post('current_video_introductorio');
    if (isset_archivo('video_introductorio')) {
        if (file_exists("contenido/videos/cursos/$video_introductorio_name")) {
            unlink("contenido/videos/cursos/$video_introductorio_name");
        }
        $video_introductorio_name = $id_curso_virtual . '-' . rand(1, 999) . str_replace(' ', '-', archivoName('video_introductorio'));
        move_uploaded_file(archivo('video_introductorio'), "contenido/videos/cursos/$video_introductorio_name");
    }
    */
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <table class="table table-striped">
                                                ...
                                                <tr>
                                                    <td>
                                                        T&iacute;tulo del curso virtual:
                                                    </td>
                                                    <td colspan="2">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($rqmc2['imagen'] == '') {
                                                            ...
                                                            ?>
                                                            <a href="contenido/imagenes/cursos/<?php echo $rqmc2['imagen']; ?>" target="_blank">
...
<!--                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="col-md-4 text-center">
                                            <?php
                                            /*
                                            if ($curso['video_introductorio'] == '') {
                                                echo "<b>SIN VIDEO INTRODUCTORIO</b>";
                                            } else {
                                                echo "<a href='contenido/videos/cursos/" . $curso['video_introductorio'] . "' target='_blank'><b>VER VIDEO ACTUAL</b></a>";
                                            }
                                            */
                                            ?>
                                        </div>
...
<script>
    function cambiar_estado_curso(id_curso, estado) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-virtuales-editar.cambiar_estado_curso.php',
