...
$grupo = mysql_fetch_array($resultado_paginas);
...
/* url_corta */
$url_corta = 'https://cursos.bo/' . abs((int) $grupo['id'] - 1000) . '/';
                                            ...
                                            <td colspan="2">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        ...
                                                        if ($grupo['imagen_gif'] !== '') {
                                                            $url_img = $dominio . "contenido/imagenes/paginas/" . $grupo['imagen_gif'];
                                                        }
                                                        ?>
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        ...
                                                        if (file_exists($url_img)) {
                                                            $url_img = "paginas/" . $grupo['imagen'] . ".size=2.img";
                                                        } else {
                                                            $url_img = "https://www.infosicoes.com/" . "paginas/" . $grupo['imagen'] . ".size=2.img";
                                                        }
                                                        ?>
                                                        <img src="<?php echo $url_img; ?>" style="height:35px;border:1px solid #AAA;border-radius:3px;padding:2px;"/>
                                                    </div>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        ...
                                                        if (file_exists($url_img)) {
                                                            $url_img = "paginas/" . $grupo['imagen2'] . ".size=2.img";
                                                        } else {
                                                            $url_img = "https://www.infosicoes.com/" . "paginas/" . $grupo['imagen2'] . ".size=2.img";
                                                        }
                                                        ?>
                                                        <img src="<?php echo $url_img; ?>" style="height:35px;border:1px solid #AAA;border-radius:3px;padding:2px;"/>
                                                    </div>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        ...
                                                        if (file_exists($url_img)) {
                                                            $url_img = "paginas/" . $grupo['imagen3'] . ".size=2.img";
                                                        } else {
                                                            $url_img = "https://www.infosicoes.com/" . "paginas/" . $grupo['imagen3'] . ".size=2.img";
                                                        }
                                                        ?>
                                                        <img src="<?php echo $url_img; ?>" style="height:35px;border:1px solid #AAA;border-radius:3px;padding:2px;"/>
                                                    </div>
                                            ...
                                            <td colspan="2">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        ...
                                                        if (file_exists($url_img)) {
                                                            $url_img = "paginas/" . $grupo['imagen4'] . ".size=2.img";
                                                        } else {
                                                            $url_img = "https://www.infosicoes.com/" . "paginas/" . $grupo['imagen4'] . ".size=2.img";
                                                        }
                                                        ?>
                                                        <img src="<?php echo $url_img; ?>" style="height:35px;border:1px solid #AAA;border-radius:3px;padding:2px;"/>
                                                    </div>
...
<script>
    function edita_certificado_general(id_certificado) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-grupos-editar.edita_certificado_general_p1.php',
...
<script>
    function actualiza_lugares() {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-grupos-editar.actualiza_lugares.php',
...
<script>
    function actualiza_ciudades() {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-grupos-editar.actualiza_ciudades.php',
...
<script>
    function busca_etiquetas(dat) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-grupos-editar.busca_etiquetas.php',
...
<script>
    function asocia_etiqueta(dat) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-grupos-editar.asocia_etiqueta.php',
...
<script>
    function quitar_etiqueta(dat) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-grupos-editar.quitar_etiqueta.php',
            data: {id_tag: dat, id_curso: '<?php echo $id_grupo; ?>'},
            type: 'POST',
            dataType: 'html',
            success: function (data) {
...
<script>
    function cambiar_estado_grupo(id_grupo, estado) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-grupos-editar.cambiar_estado_grupo.php',
...
<script>
    function modificar_asignacion_onlinecourse(id_asignacion_onlinecourse) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-grupos-editar.modificar_asignacion_onlinecourse.php',
...
<script>
    function modificar_asignacion_onlinecourse_p2() {
        ...
        $("#AJAXBOX-modificar_asignacion_onlinecourse").html("Procesando...");
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-grupos-editar.modificar_asignacion_onlinecourse_p2.php',
            data: formdata,
            type: 'POST',
            dataType: 'html',
            success: function (data) {
...
<script>
    function edicion_tituloFechaCostos() {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-grupos-editar.edicion_tituloFechaCostos.php',
            data: formdata,
            type: 'POST',
            dataType: 'html',
            success: function (data) {
