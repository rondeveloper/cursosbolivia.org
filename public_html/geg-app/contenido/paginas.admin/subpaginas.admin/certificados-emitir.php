...
$datos_empresa = mysql_fetch_array($resultado_datos_empresa);

//datos de paquete
$rp1 = query("SELECT * FROM paquetes WHERE id='" . $datos_empresa['id_paquete'] . "' ");
$rp2 = mysql_fetch_array($rp1);
...
<div class="formulario_edicion_datos_empresa">
    ...
    <div class="tabla_panel_uno" style="" id="box_reg_empresa">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select name="id_curso" class="form-control form-cascade-control">
                                                ...
                                                while ($r_paquete2 = mysql_fetch_array($r_paquete1)) {
            ...
            <table class="table users-table table-condensed table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="visible-lg">     
                            <a href="http://www.infosicoes.com/contenido/librerias/fpdf/tutorial/certificado-2.php" target="_blank">Imprimir certificado</a>         
                        </td>
                    </tr>
                </tbody>
            </table>
...
<script language="Javascript">
    function cambiar_paquete(id) {
        ...
        ajax.open("POST", "contenido/paginas.admin/ajax/ajax.cambiar_paquete.php?fecha_inicio=" + fecha_inicio + "&duracion=" + duracion, true);
