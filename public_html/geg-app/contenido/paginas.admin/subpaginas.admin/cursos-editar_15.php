    ...
    <div class="col-md-12">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                ?>
                <div class="panel panel-primary">
                    <div class="panel-heading">NOMBRE / FECHAS / COSTOS - <?php echo $curso['titulo']; ?></div>
                        ...
                        if ($sw_edicion_tituloFechaCostos) {
                            ...
                            <div class="panel-footer">
                                <div style="text-align: center;padding:20px;">
                                    ...
                                    <b class="btn btn-primary btn-block" onclick="edicion_tituloFechaCostos();">ACTUALIZAR DATOS</b>
                                </div>
                            </div>
                            <?php
                        }
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">DATOS GENERALES - <?php echo $curso['titulo']; ?></div>
