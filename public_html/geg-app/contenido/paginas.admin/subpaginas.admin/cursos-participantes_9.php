            ...
            <div class="hidden-sm">
                ...
                if (acceso_cod('adm-cursos-estado')) {
                    ...
                    <span id="box-desactivar-curso">
                        <a class="btn btn-xs btn-default" onclick="desactivar_curso('<?php echo $id_curso; ?>');"><i class="fa ffa-level-down"></i> DESACTIVAR CURSO</a>
                        &nbsp;&nbsp;
                        &nbsp;|&nbsp;
                    </span>
                    <?php
...
<script>
function desactivar_curso(dat) {
        $("#box-desactivar-curso").html("Cargando...");
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-participantes.desactivar_curso.php',
            data: {dat:dat},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
