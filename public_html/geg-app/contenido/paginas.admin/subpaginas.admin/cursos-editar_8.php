                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <form enctype="multipart/form-data" action="" method="post">
                                <div class="row" style="background:#EEE;margin-bottom: 10px;padding:10px 0px;">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div>
                                            <input type="submit" name="actualizar-estado" value="ACTUALIZAR ESTADO" class="btn btn-success btn-sm active btn-block"/>
                                        </div>
                                    </div>
                                </div>
                                <?php
                                    ...
                                    <table style="width:100%;" class="table table-striped">
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div class="col-md-9">
                                                    <select class="form-control" name="id_departamento" id="select_departamento" onchange="actualiza_lugares();">
                                                        <?php
                                                ...
                                                <div class="col-md-9">
                                                    <div class="form-group input-group">
                                                        <select class="form-control" name="id_lugar" id="select_lugar">
                                                            ...
                                                            $rqdl1 = query("SELECT id,nombre,salon,direccion FROM cursos_lugares WHERE id_departamento='" . $curso['id_ciudad'] . "' ORDER BY nombre ASC ");
                                                ...
                                                <div class="panel-group">
                                                    <div class="panel panel-default">
                                                        <div class="panel-heading">
                                                            <a data-toggle="collapse" href="#collapse_TC">
                                                                <h4 class="panel-title">
                                                                    Contenido din&aacute;mico [TAGs]
                                                                </h4>
                                                            </a>
                                                        </div>
...
<script>
    function actualiza_lugares() {
        ...
        $.ajax({
            ...
            data: {id_departamento: id_departamento, current_id_lugar: current_id_lugar},
            type: 'POST',
            dataType: 'html',
