...
if (isset_post('agregar-participante')) {
    ...
    if ((strlen(post('nombres')) > 3) && (strlen(post('apellidos')) > 3)) {
        ...
        $rqpcv1 = query("SELECT id FROM capacitaciones_participantes WHERE nombres='$nombres' AND apellidos='$apellidos' AND id_capacitacion='$id_capacitacion' ORDER BY id DESC limit 1 ");
  ...
  <strong>Alerta!</strong> nombre ya existe como participante en este capacitacion.
            ...
            $cod_reg = substr("RM-$id_capacitacion-" . str_replace(" ", "-", $nombres), 0, 14);
            $fecha_registro = date("Y-m-d H:i:s");

            query("INSERT INTO capacitaciones_proceso_registro(
                      id_capacitacion, 
                      id_modo_de_registro,
                      cod_reg, 
                      metodo_de_pago, 
            ...
            $rqcr1 = query("SELECT id FROM capacitaciones_proceso_registro WHERE cod_reg='$cod_reg' ORDER BY id DESC limit 1 ");
            $rqcr2 = mysql_fetch_array($rqcr1);
            $id_proceso_registro = $rqcr2['id'];
            $codigo_registro = "RM00" . $id_proceso_registro;
            query("UPDATE capacitaciones_proceso_registro SET codigo='$codigo_registro' WHERE id='$id_proceso_registro' ORDER BY id DESC limit 1 ");

            query("INSERT INTO capacitaciones_participantes (
                      id_capacitacion,
                      id_proceso_registro,
                      prefijo,
                      nombres,
            ...
            $rqpc1 = query("SELECT id FROM capacitaciones_participantes WHERE nombres='$nombres' AND apellidos='$apellidos' ORDER BY id DESC limit 1 ");
            $rqpc2 = mysql_fetch_array($rqpc1);
            movimiento('Agregado de participante a capacitacion [capacitacion: ' . $id_capacitacion . '] ', 'agregado-participante-capacitacion', 'participante-capacitacion', $rqpc2['id']);

            /* agregado de cursos seleccionados */
            $rqcc1 = query("SELECT * FROM capacitaciones_cursos WHERE id_capacitacion='$id_capacitacion' ORDER BY id ASC ");
            while ($rqcc2 = mysql_fetch_array($rqcc1)) {
                if (isset_post('curso-capacitacion-' . $rqcc2['id'])) {
                    query("INSERT INTO rel_p_capacitacion_curso(
                           id_capacitacion, 
                           id_capacitacion_participante, 
                           id_capacitacion_curso
                           ) VALUES (
                           '$id_capacitacion',
                           '".$rqpc2['id']."',
                           '".$rqcc2['id']."'
...
$resultado1 = query("SELECT * FROM capacitaciones_participantes WHERE id_capacitacion='$id_capacitacion' AND estado='1' ORDER BY id DESC ");
...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Participantes del Ciclo de Capacitaci&oacute;n <i class="fa fa-info-circle animated bounceInDown show-info"></i> </h3>
        <blockquote class="page-information hidden">
            <p>
                Listado de participantes del Ciclo de Capacitaci&oacute;n
            </p>
        </blockquote>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel">
                    ...
                    <div class="panel-body">
                        <table class="table" style="background:#EEE;border-radius:5px;">
                            ...
                            <tr>
                                ...
                                <td><a href="#demo" data-toggle="collapse" class="btn btn-warning active">SELECCIONAR CURSOS</a></td>
                            </tr>
                            ...
                            <div class="panel-body">
                                <table class="table">
                                    ...
                                    while ($rqcc2 = mysql_fetch_array($rqcc1)) {
                                        ...
                                        <tr>
                                            <td>
                                                <label for="f-<?php echo $rqcc2['id']; ?>">
                                                    <input type="checkbox" name="curso-capacitacion-<?php echo $rqcc2['id']; ?>" value="1" id="f-<?php echo $rqcc2['id']; ?>"/>
                                                    &nbsp;&nbsp;
                                                    <?php echo $rqcc2['titulo_curso']; ?>
                                                </label>
                                            </td>
                                            <td>
                                                <?php echo $rqcc2['horario']; ?>
                                            </td>
                                        </tr>
                                        <?php
                                    }
            ...
            if (mysql_num_rows($resultado1) == 0) {
                echo "<p>No se registraron participantes para este capacitacion</p>";
            }
            ?>
                ...
                <table class="table users-table table-condensed table-hover">
                    ...
                    <tbody>
                        ...
                        while ($participante = mysql_fetch_array($resultado1)) {
                            ...
                            /* datos de registro */
                            $rqrp1 = query("SELECT codigo,fecha_registro,celular_contacto,correo_contacto,metodo_de_pago,id_modo_de_registro,id_emision_factura,monto_deposito,imagen_deposito,razon_social,nit,cnt_participantes FROM capacitaciones_proceso_registro WHERE id='" . $participante['id_proceso_registro'] . "' ORDER BY id DESC limit 1 ");
                            ...
                            if ($participante['id_emision_certificado'] == '0') {
                                ...
                                $rqidc1 = query("SELECT certificado_id FROM capacitaciones_emisiones_certificados WHERE id='" . $participante['id_emision_certificado'] . "' ORDER BY id DESC limit 1 ");
                                $rqidc2 = mysql_fetch_array($rqidc1);
                                //echo $rqidc2['certificado_id'];
                                /* segundo certificado */
                                if ($participante['id_emision_certificado_2'] !== '0') {
                                    $rqidcc1 = query("SELECT certificado_id FROM capacitaciones_emisiones_certificados WHERE id='" . $participante['id_emision_certificado_2'] . "' ORDER BY id DESC limit 1 ");
                            ...
                            <tr id="ajaxbox-tr-participante-<?php echo $participante['id']; ?>">
                                ...
                                <td class="visible-lg">
                                    <?php
                                    $rqccr1 = query("SELECT count(*) AS total FROM rel_p_capacitacion_curso WHERE id_capacitacion='$id_capacitacion' AND id_capacitacion_participante='".$participante['id']."' ");
                                    $rqccr2 = mysql_fetch_array($rqccr1);
                                    echo $rqccr2['total']." curso(s)";
                                    ?>
                                </td>
                                <td class="visible-lg">
                                    <?php
...
<!--                                    <a data-toggle="modal" data-target="#MODAL-facturacion-registro-<?php echo $participante['id']; ?>" onclick="" class="btn btn-xs btn-success">Fact.</a>
                                    ...
                                    if (true) {
                                        ...
                                        if ($id_certificado_capacitacion == '0') {
                                            ...
                                            if ($participante['id_emision_certificado'] == '0' && $sw_habilitacion_procesos) {
                                                ...
                                                <?php
                                                $aux = "<br/><a href='capacitaciones-participantes-editar-certificado/" . $rqidc2['certificado_id'] . ".adm' class='btn btn-xs btn-warning' target='_blank'> <i class='fa fa-edit'></i> cert</a>";
                                            }

                                            /* segundo certificado */
                                            if ($id_certificado_2_capacitacion !== '0') {
                                                if ($participante['id_emision_certificado_2'] == '0' && $sw_habilitacion_procesos) {
                                                    ...
                                                    <?php
                                                    $aux .= " - <a href='capacitaciones-participantes-editar-certificado/" . $rqidcc2['certificado_id'] . ".adm' class='btn btn-xs btn-warning' target='_blank'> <i class='fa fa-edit'></i> cert 2</a>";
                                                }
                                            }
                                        }
                                    }
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-6 text-left">
                                                ...
                                                <br/>
                                                <b>CERTIFICADO:</b> <?php echo $codigo_de_certificado_del_capacitacion; ?>
                                                <br/>
                                        ...
                                        <input type="hidden" id="id_certificado-<?php echo $participante['id']; ?>" value="<?php echo $id_certificado_capacitacion; ?>" />
                                        <input type="hidden" id="id_capacitacion-<?php echo $participante['id']; ?>" value="<?php echo $id_capacitacion; ?>" />
                                        ...
                                        <div class="text-center" id='box-modal_emision_certificado-<?php echo $participante['id']; ?>'>
                                            ...
                                            <button class="btn btn-success" onclick="capacitacion_emitir_certificado('<?php echo $participante['id']; ?>');">EMITIR CERTIFICADO</button>
                                            &nbsp;&nbsp;&nbsp;
                        ...
                        <?php
                        /* segundo certificado */
                        if (false && $id_certificado_2_capacitacion !== '0') {

                            //datos del capacitacion
                            $rqc_c2_1 = query("select codigo from capacitaciones_certificados where id='$id_certificado_2_capacitacion' ");
                            $rqc_c2_2 = mysql_fetch_array($rqc_c2_1);
                            $codigo_de_certificado_2_del_capacitacion = $rqc_c2_2['codigo'];
                            ?>
                            <!-- Modal-2 -->
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-md-6 text-left">
                                                    ...
                                                    <b>FECHA:</b> <?php echo $fecha_del_capacitacion; ?>
                                                    <br/>
                                                    <b>CERTIFICADO:</b> <?php echo $codigo_de_certificado_2_del_capacitacion; ?>
                                                    <br/>
                                                    <b>PARTICIPANTE:</b> <?php echo trim($participante['nombres'] . ' ' . $participante['apellidos']); ?>
                                                </div>
                                                <div class="col-md-6 text-right">
                                            ...
                                            <div class="text-center" id='box-modal_emision_certificado-2-<?php echo $participante['id']; ?>'>
                                                ...
                                                <br/>
                                                <br/>
                                                <input type="hidden" id="id_certificado-2-<?php echo $participante['id']; ?>" value="<?php echo $id_certificado_2_capacitacion; ?>" />

                                                <button class="btn btn-success" onclick="capacitacion_emitir_certificado_2('<?php echo $participante['id']; ?>');">EMITIR 2do CERTIFICADO</button>
                                                &nbsp;&nbsp;&nbsp;
                                                <button class="btn btn-danger" onclick="" data-dismiss="modal">CANCELAR</button>
                                            </div>
                                            <hr/>
                                            ...
                                            if ($sw_habilitacion_procesos) {
                                                ...
                                                <div class="text-center" id='box-modal_emision_factura-<?php echo $participante['id']; ?>'>
                                                    ...
                                                    <div class="text-center">
                                                        <button class="btn btn-success" onclick="capacitacion_emitir_factura('<?php echo $participante['id']; ?>');">EMITIR FACTURA</button>
                                                        &nbsp;&nbsp;&nbsp;
                                                        <button class="btn btn-danger" onclick="" data-dismiss="modal">CANCELAR</button>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="text-center" id='box-modal_emision_certificado-<?php echo $participante['id']; ?>'>
                                                ...
                                                <input type="hidden" name="id_capacitacion" value="<?php echo $id_capacitacion; ?>" />
                ...
                <table class="table users-table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        $resultado1 = query("SELECT * FROM capacitaciones_participantes WHERE id_capacitacion='$id_capacitacion' AND estado='0' ORDER BY id DESC ");
                        if (mysql_num_rows($resultado1) == 0) {
...
<script>
    function capacitacion_emitir_certificado(dat) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.modal.capacitacion_emitir_certificado.php',
...
<script>
    function capacitacion_emitir_certificado_2(dat) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.modal.capacitacion_emitir_certificado.php?segundo_certificado=true',
            data: {receptor_de_certificado: receptor_de_certificado, id_certificado: id_certificado, id_capacitacion: id_capacitacion, id_participante: id_participante},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
...
<script>
    function capacitacion_emitir_factura(dat) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.modal.capacitacion_emitir_factura.php',
...
<script>
    function eliminar_participante(dat) {
        ...
        if (confirm("Desea eliminar al participante?")) {
            ...
            $.ajax({
                url: 'contenido/paginas.admin/ajax/ajax.instant.capacitacion_eliminar_participante.php',
                data: {dat: dat},
                type: 'POST',
                dataType: 'html',
                success: function(data) {
...
<script>
    function habilitar_participante(dat) {
        ...
        if (confirm("Desea habilitar nuevamente al participante?")) {
            ...
            $.ajax({
                url: 'contenido/paginas.admin/ajax/ajax.instant.capacitacion_habilitar_participante.php',
                data: {dat: dat},
                type: 'POST',
                dataType: 'html',
                success: function(data) {
...
<script>
    function emision_multiple_certificados() {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.modal.capacitaciones-participantes.emision_multiple_certificados.php',
            data: {dat: ids.join(',')},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
...
<script>
    function emision_multiple_certificados_p2() {
        ...
        $("#box-modal_emision_certificados-multiple").html('<img src="contenido/imagenes/images/load_ajax.gif"/>');
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.modal.capacitaciones-participantes.emision_multiple_certificados_p2.php',
...
<script>
    function emision_multiple_facturas() {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.modal.capacitaciones-participantes.emision_multiple_facturas.php',
            data: {dat: ids.join(',')},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
...
<script>
    function emision_multiple_facturas_p2() {
        ...
        $("#box-modal_emision_facturas-multiple").html('<img src="contenido/imagenes/images/load_ajax.gif"/>');
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.modal.capacitaciones-participantes.emision_multiple_facturas_p2.php',
            data: {dat: ids.join(','), id_certificado: id_certificado, id_capacitacion: id_capacitacion},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
...
<script>
    function generar_reporte(formato) {
        ...
        window.open('http://www.infosicoes.com/contenido/paginas.admin/ajax/ajax.impresion.capacitaciones-participantes.exportar-lista.php?id_capacitacion=<?php echo $id_capacitacion; ?>&' + formato + '=true&' + data_required, 'popup', 'width=700,height=500');
