    ...
    <table class="table table-striped">
        ...
        <tr>
            <td colspan="2">
                <br/>
                <br/>
                <b>Impresi&oacute;n -> </b> <button onclick="window.open(\'https://cursos.bo/contenido/librerias/fpdf/tutorial/recibo-1.php?nro_recibo='.$nro_recibo.'\', \'popup\', \'width=700,height=500\');" class="btn btn-default btn-xs">IMPRIMIR RECIBO</button>
