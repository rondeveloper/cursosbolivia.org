                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select name="duracion" class="form-control form-cascade-control">
                                                                        ...
                                                                        <option value="6" style="padding:4px;" selected="selected">Medio A&ntilde;o</option>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <select name="duracion" class="form-control form-cascade-control">
                                                                                        ...
                                                                                        <option value="6" style="padding:4px;" <?php echo $txt_selected; ?>>Medio A&ntilde;o</option>
