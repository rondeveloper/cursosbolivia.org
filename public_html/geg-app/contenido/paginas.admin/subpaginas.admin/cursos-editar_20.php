...
if (isset_post('habilitar-certificado')) {
    ...
    $nombre_tematica = '';
    if ($id_tematica !== '0') {
        $rqdt1 = query("SELECT titulo FROM cursos_tematicas WHERE id='$id_tematica' ORDER BY id DESC LIMIT 1 ");
        $rqdt2 = mysql_fetch_array($rqdt1);
        $nombre_tematica = $rqdt2['titulo'];
    }
    $cont_dos = str_replace('[NOMBRE-TEMATICA]', $nombre_tematica, $cont_dos);
    $texto_qr = str_replace('[NOMBRE-TEMATICA]', $nombre_tematica, $texto_qr);
...
if (isset_post('editar-curso')) {
    ...
    $id_cuenta_bancaria = post('id_cuenta_bancaria');
    ...
    query("UPDATE cursos SET 
              ...
              id_whats_numero='$id_whats_numero',
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <span class="input-group-addon" id="basic-addon1">
                                                            <select name="id_abreviacion" <?php echo $txt_disabled ?>>
                                                                ...
                                                                while ($rqdca2 = mysql_fetch_array($rqdca1)) {
                                                                    $selected = '';
                                    ...
                                    <table style="width:100%;" class="table table-striped">
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div class="col-md-3">
                                                    <span class="input-group-addon"><i class="fa fa-calendar"></i> &nbsp; Cuenta bancaria: </span>
                                                </div>
                                                <div class="col-md-3">
                                                    <select class="form-control form-cascade-control" name="id_cuenta_bancaria">
                                                        <?php
                                                        $rqdcb1 = query("SELECT * FROM cuentas_de_banco WHERE estado='1' ");
                                                        while ($rqdcb2 = mysql_fetch_array($rqdcb1)) {
                                                            $selected = '';
                                                            if ($curso['id_cuenta_bancaria'] == $rqdcb2['id']) {
                                                                $selected = ' selected="selected" ';
                                                            }
                                                            ?>
                                                            <option value="<?php echo $rqdcb2['id']; ?>" <?php echo $selected; ?> ><?php echo $rqdcb2['numero_cuenta'].'  |  '.$rqdcb2['banco'].'  |  '.$rqdcb2['titular']; ?></option>
                                                            <?php
                                                        }
                                                        ?>
                                                    </select>
                                    ...
                                    <table style="width:100%;" class="table table-striped">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control" name="id_whats_numero">
                                                        <?php
                                                        $rqwn1 = query("SELECT id,numero,responsable FROM whatsapp_numeros WHERE estado='1' ORDER BY id ASC ");
                                                        while ($rqwn2 = mysql_fetch_array($rqwn1)) {
                                                            $selected = '';
                                                            if ($curso['id_whats_numero'] == $rqwn2['id']) {
                                                                $selected = ' selected="selected" ';
                                                            }
                                                            echo '<option value="' . $rqwn2['id'] . '" ' . $selected . ' >' . $rqwn2['numero'] . ' | ' . $rqwn2['responsable'] . '</option>';
                                                        }
                                                        ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="id_material" id="select_docente">
                                                            ...
                                                            while ($rqmt2 = mysql_fetch_array($rqmt1)) {
                                                                $selected = '';
                                                ...
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    <tr>
                                                        <td colspan="3" class="text-center">
                                                            <br>
                                                            <br>
                                                            <a class="btn btn-warning btn-lg" data-toggle="modal" data-target="#MODAL-habilitar-onlinecourse"><i class="fa fa-plus"></i> AGREGAR CURSO VIRTUAL</a>
                                                            <br>
                                                            <br>
                                                            <br>
                                                        </td>
            ...
            <div class="modal-body">
                ...
                <form action='' method='post' enctype="multipart/form-data">
                    <table class="table table-striped table-bordered">
                        <tr>
                            <td>
                                <span class="input-group-addon"><b>TEM&Aacute;TICA:</b></span>
                            </td>
                            <td>
                                <select type="text" class="form-control" name="id_tematica">
                                    <option value="0">Sin tem&aacute;tica...</option>
                                    <?php
                                    $rqfct1 = query("SELECT id,titulo FROM cursos_tematicas WHERE estado='1' ORDER BY id DESC");
                                    while ($rqfct2 = mysql_fetch_array($rqfct1)) {
                                        ?>
                                        <option value="<?php echo $rqfct2['id']; ?>"><?php echo $rqfct2['titulo']; ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <tr>
                            <td>
                                <span class="input-group-addon"><b>T&Iacute;TULO:</b></span>
                            </td>
                            <td>
...
<!--                                <input type="text" class="form-control" name="contenido_uno_certificado" value='<?php echo ("Por cuanto se reconoce que completo satisfactoriamente el curso de capacitación:"); ?>'/>-->
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                ?>
                                <textarea  class="form-control" name="contenido_dos_certificado" rows="2">"[NOMBRE-TEMATICA]<?php //echo $aux_txt_texto_qr;     ?>", con una carga horaria de 10 horas.</textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>
...
<!--                                <input type="text" class="form-control" name="contenido_tres_certificado" value="Realizado en <?php echo $rqcc2['nombre']; ?>, Bolivia a los <?php echo $dia_curso; ?> dias del mes de <?php echo $array_meses[(int) $mes_curso]; ?> de <?php echo date('Y'); ?>"/>-->
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea class="form-control" name="texto_qr" rows="2">[NOMBRE-TEMATICA]<?php //echo $aux_txt_texto_qr;    ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>
...
<!--                                <input type="text" class="form-control" name="contenido_dos_certificado" value='"<?php echo $curso['titulo']; ?>", con una carga horaria de 8 horas.'/>-->
                                <textarea  class="form-control" name="contenido_dos_certificado" rows="2">"[NOMBRE-TEMATICA]<?php //echo $aux_txt_texto_qr;     ?>", con una carga horaria de 8 horas.</textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>
...
<script>
    function genera_htmlcurso_individual(id_curso) {
        $.ajax({
            url: 'contenido/paginas.admin/cron/cron.genera_htmls.php?page=curso-individual&id_curso=' + id_curso,
            type: 'GET',
            dataType: 'html',
            success: function (data) {
                console.log(data);
