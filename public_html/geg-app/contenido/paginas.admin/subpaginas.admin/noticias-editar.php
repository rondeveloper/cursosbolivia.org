...
if (isset_post('editar-curso')) {
    ...
    if (isset_archivo('imagen')) {
        ...
        move_uploaded_file(archivo('imagen'), "contenido/imagenes/noticias/$imagen");
    }
    if (isset_archivo('imagen2')) {
        $imagen2 = time() . str_replace("'", "", archivoName('imagen2'));
        move_uploaded_file(archivo('imagen2'), "contenido/imagenes/noticias/$imagen2");
    }
    if (isset_archivo('imagen3')) {
        $imagen3 = time() . str_replace("'", "", archivoName('imagen3'));
        move_uploaded_file(archivo('imagen3'), "contenido/imagenes/noticias/$imagen3");
    }
    if (isset_archivo('imagen4')) {
        $imagen4 = time() . str_replace("'", "", archivoName('imagen4'));
        move_uploaded_file(archivo('imagen4'), "contenido/imagenes/noticias/$imagen4");
    }


    if (isset_archivo('archivo1')) {
        $archivo1 = 'C' . $id_noticia . '-' . str_replace("'", "", archivoName('archivo1'));
        move_uploaded_file(archivo('archivo1'), "contenido/archivos/noticias/$archivo1");
    }
    if (isset_archivo('archivo2')) {
        $archivo2 = 'C' . $id_noticia . '-' . str_replace("'", "", archivoName('archivo2'));
        move_uploaded_file(archivo('archivo2'), "contenido/archivos/noticias/$archivo2");
    }
    if (isset_archivo('archivo3')) {
        $archivo3 = 'C' . $id_noticia . '-' . str_replace("'", "", archivoName('archivo3'));
        move_uploaded_file(archivo('archivo3'), "contenido/archivos/noticias/$archivo3");
    }
    if (isset_archivo('archivo4')) {
        $archivo4 = 'C' . $id_noticia . '-' . str_replace("'", "", archivoName('archivo4'));
        move_uploaded_file(archivo('archivo4'), "contenido/archivos/noticias/$archivo4");
    }
    if (isset_archivo('archivo5')) {
        $archivo5 = 'C' . $id_noticia . '-' . str_replace("'", "", archivoName('archivo5'));
        move_uploaded_file(archivo('archivo5'), "contenido/archivos/noticias/$archivo5");
    }
...
$noticia = mysql_fetch_array($resultado_paginas);
...
/* url_corta */
$url_corta = 'https://cursos.bo/' . $noticia['titulo_identificador'] . '.html';
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        ...
                                                        if ($noticia['archivo1'] == '') {
                                                            ...
                                                            if (file_exists("contenido/archivos/noticias/" . $noticia['archivo1'])) {
                                                                $url_arch = $dominio . "contenido/archivos/noticias/" . $noticia['archivo1'];
                                                            } else {
                                                                $url_arch = "https://www.infosicoes.com/" . "contenido/archivos/noticias/" . $noticia['archivo1'];
                                                            }
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        ...
                                                        if ($noticia['archivo2'] == '') {
                                                            ...
                                                            if (file_exists("contenido/archivos/noticias/" . $noticia['archivo2'])) {
                                                                $url_arch = $dominio . "contenido/archivos/noticias/" . $noticia['archivo2'];
                                                            } else {
                                                                $url_arch = "https://www.infosicoes.com/" . "contenido/archivos/noticias/" . $noticia['archivo2'];
                                                            }
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        ...
                                                        if ($noticia['archivo3'] == '') {
                                                            ...
                                                            if (file_exists("contenido/archivos/noticias/" . $noticia['archivo3'])) {
                                                                $url_arch = $dominio . "contenido/archivos/noticias/" . $noticia['archivo3'];
                                                            } else {
                                                                $url_arch = "https://www.infosicoes.com/" . "contenido/archivos/noticias/" . $noticia['archivo3'];
                                                            }
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        ...
                                                        if ($noticia['archivo4'] == '') {
                                                            ...
                                                            if (file_exists("contenido/archivos/noticias/" . $noticia['archivo4'])) {
                                                                $url_arch = $dominio . "contenido/archivos/noticias/" . $noticia['archivo4'];
                                                            } else {
                                                                $url_arch = "https://www.infosicoes.com/" . "contenido/archivos/noticias/" . $noticia['archivo4'];
                                                            }
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        ...
                                                        if ($noticia['archivo5'] == '') {
                                                            ...
                                                            if (file_exists("contenido/archivos/noticias/" . $noticia['archivo5'])) {
                                                                $url_arch = $dominio . "contenido/archivos/noticias/" . $noticia['archivo5'];
                                                            } else {
                                                                $url_arch = "https://www.infosicoes.com/" . "contenido/archivos/noticias/" . $noticia['archivo5'];
                                                            }
...
<script>
    function cambiar_estado_noticia(id_noticia, estado) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.noticias-editar.cambiar_estado_noticia.php',
