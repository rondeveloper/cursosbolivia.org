...
/* datos curso virtual */
$rqdcv1 = query("SELECT cv.titulo,cv.urltag,r.fecha_inicio,r.fecha_final,r.id_onlinecourse FROM cursos_onlinecourse cv INNER JOIN cursos_rel_cursoonlinecourse r ON cv.id=r.id_onlinecourse WHERE cv.id='$id_onlinecourse' ORDER BY r.id DESC limit 1 ");
...
<p align="justify">Le invitamos a que esta semana ingrese a los recursos del curso y explore las pesta&ntilde;as de capacitaci&oacute;n donde encontrar&aacute; informaci&oacute;n sobre esta propuesta de formaci&oacute;n: los objetivos, la metodolog&iacute;a, el cronograma, en fin el programa completo del curso. Recuerde que el acceso al curso virtual y sus recursos estar&aacute;n disponibles para usted las 24 horas del d&iacute;a desde su primer ingreso hasta 4 semanas despues, el tiempo sugerido de ingreso y culminaci&oacute;n de este curso virtual es desde '.$fecha_incio_cursovirtual.' hasta '.$fecha_final_cursovirtual.' por lo que le recomendamos completar el curso dentro de estas fechas.</p>
<br/>
...
logcursos('Envio de correo bienvenida curso-virtual [CV:'.$id_onlinecourse.']', 'partipante-cvirtual', 'participante', $id_participante);
?>
