...
if (isset_administrador()) {
    ...
    <button class="btn btn-success" onclick="window.open('http://www.infosicoes.com/contenido/librerias/fpdf/tutorial/certificado-3-masivo.php?id_participantes=<?php echo $ids_participantes_env; ?>&id_modelo_certificado=<?php echo $id_modelo_certificado; ?>', 'popup', 'width=700,height=500');">IMPRIMIR EMITIDOS</button>
