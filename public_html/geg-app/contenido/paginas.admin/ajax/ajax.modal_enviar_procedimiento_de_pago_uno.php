...
if (isset_administrador() && isset_post('dat')) {
    ...
    if (mysql_num_rows($rqv1) > 0) {
        ...
        $rpl2 = mysql_fetch_array($rpl1);
        $contenido_planes_infosicoes = str_replace('<li>', '<li style="list-style:none;"><img src="https://www.infosicoes.com/contenido/imagenes/images/icon-11.png"/> ', $rpl2['contenido']);
    ...
    <div style='background:#FFF;width:80%;margin:auto;padding:30px;border:1px solid #56829c;border-radius:5px;color:#333;'><h2 style='text-align:center;background:#003e54;color:#FFF;border-radius:5px;padding:5px;'>Procedimiento de adquisici&oacute;n de paquete EMPRESARIAL - InfoSICOES</h2>
        ...
        $asunto = utf8_encode("Procedimiento de adquisición de paquete EMPRESARIAL - InfoSICOES [$nomempresa]");
        ...
        if (envio_email_ventas($correo_empresa, $asunto, $msj)) {
            ...
            echo " <img src='contenido/imagenes/images/bien.png' style='width:25px;'>  Correo de procedimiento enviado!<hr/>$htm_mensaje_wap<hr/>";
        } else {
