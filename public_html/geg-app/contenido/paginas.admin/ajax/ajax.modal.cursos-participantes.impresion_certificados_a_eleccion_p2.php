...
if (isset_administrador()) {
    ...
    <div class="row">
        <ul>
            ...
            while ($rqcp2 = mysql_fetch_array($rqcp1)) {
                ...
                $rqic2 = mysql_fetch_array($rqic1);
                
                $certificado_id = $rqic2['certificado_id'];
                
                ?>                
                <li style='font-size: 15pt !important;padding-bottom: 7pt;'>
                    <?php echo trim($rqcp2['prefijo'] . ' ' . $rqcp2['nombres'] . ' ' . $rqcp2['apellidos']); ?> -> </b> <button onclick="window.open('http://www.infosicoes.com/contenido/librerias/fpdf/tutorial/certificado-3.php?id_certificado=<?php echo $certificado_id; ?>', 'popup', 'width=700,height=500');" class="btn btn-default btn-xs">IMPRIMIR CERTIFICADO</button>
                </li>
    ...
    <button class="btn btn-success" onclick="window.open('http://www.infosicoes.com/contenido/librerias/fpdf/tutorial/certificado-3-masivo.php?id_participantes=<?php echo $ids_participantes; ?>&id_modelo_certificado=<?php echo $id_modelo_certificado; ?>', 'popup', 'width=700,height=500');">IMPRIMIR TODOS</button>
