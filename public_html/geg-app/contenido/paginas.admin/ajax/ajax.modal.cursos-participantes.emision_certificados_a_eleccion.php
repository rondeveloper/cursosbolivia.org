...
if (isset_administrador()) {
    ...
    <select class="form-control" id="id-modelo-certificado">
        <?php
    ...
    <button class="btn btn-success" onclick="emision_certificados_a_eleccion_p2();">PROCEDER CON LA EMISION</button>
