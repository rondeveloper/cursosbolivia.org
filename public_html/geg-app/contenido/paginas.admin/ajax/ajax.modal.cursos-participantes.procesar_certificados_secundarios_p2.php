...
if (isset_administrador()) {
    ...
    <div class="row">
        <table class="table table-striped">
            ...
            while ($rqmcb2 = mysql_fetch_array($rqmcb1)) {
           ...
           '1'
                    ...
                    <tr>
                        ...
                        <td><button onclick="window.open('http://www.infosicoes.com/contenido/librerias/fpdf/tutorial/certificado-3.php?id_certificado=<?php echo $certificado_id; ?>', 'popup', 'width=700,height=500');" class="btn btn-default btn-xs">IMPRIMIR CERTIFICADO</button></td>
                    </tr>
    ...
    <button class="btn btn-success" onclick="window.open('http://www.infosicoes.com/contenido/librerias/fpdf/tutorial/certificado-3-masivo.php?id_participantes=<?php echo $id_participante; ?>&id_modelo_certificado=<?php echo $ids_modelos_certificados_env; ?>', 'popup', 'width=700,height=500');">IMPRIMIR EMITIDOS</button>
