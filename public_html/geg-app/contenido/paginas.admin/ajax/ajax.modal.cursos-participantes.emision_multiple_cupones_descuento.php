...
if (isset_administrador()) {
    ...
    <button onclick="window.open('http://cursos.bo/contenido/librerias/fpdf/tutorial/cupon-descuento.php?id_cupon=<?php echo $id_cupon; ?>&id_curso=<?php echo $id_curso; ?>', 'popup', 'width=700,height=500');" class="btn btn-info active btn-block">IMPRIMIR TODOS LOS CUP&Oacute;NES</button>
    <hr/>
    <?php
} else {
    echo "Denegado!";
