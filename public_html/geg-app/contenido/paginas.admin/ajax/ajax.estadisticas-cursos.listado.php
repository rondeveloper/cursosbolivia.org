...
(select sum(inn_cpr.monto_deposito) from cursos_proceso_registro inn_cpr inner join cursos_participantes inn_cp on inn_cpr.id=inn_cp.id_proceso_registro where inn_cp.id_curso=c.id and inn_cp.estado=1 and modo_pago IN ('transferencia','deposito'))dr_total_pago_banco,
(select sum(inn_cpr.monto_deposito) from cursos_proceso_registro inn_cpr inner join cursos_participantes inn_cp on inn_cpr.id=inn_cp.id_proceso_registro where inn_cp.id_curso=c.id and inn_cp.estado=1 and modo_pago IN ('oficina','dia_curso'))dr_total_pago_efectivo,
(select sum(inn_cpr.monto_deposito) from cursos_proceso_registro inn_cpr inner join cursos_participantes inn_cp on inn_cpr.id=inn_cp.id_proceso_registro where inn_cp.id_curso=c.id and inn_cp.estado=1 and modo_pago IN ('tigomoney'))dr_total_pago_tigomoney,
(select sum(inn_cpr.monto_deposito) from cursos_proceso_registro inn_cpr inner join cursos_participantes inn_cp on inn_cpr.id=inn_cp.id_proceso_registro where inn_cp.id_curso=c.id and inn_cp.estado=1 and modo_pago NOT IN ('transferencia','deposito','oficina','dia_curso','tigomoney'))dr_total_pago_otros,
    ...
    <table class="table table-hover table-bordered table-striped">
        ...
        <tbody>
            ...
            while ($producto = mysql_fetch_array($resultado1)) {
                ...
                $rqapa2 = mysql_fetch_array($rqapa1);
