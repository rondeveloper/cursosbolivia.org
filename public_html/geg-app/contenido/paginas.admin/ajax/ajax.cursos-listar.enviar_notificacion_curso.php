    ...
    case 'usuariosreg':
        ...
        while ($rqturap2 = mysql_fetch_array($rqtur1)) {
            ...
            if((int)$rqder2['total']==0){
                ...
                enviar_email_2($correo, $asunto, $cont_preunsubscribe . $contenido_correo . $cont_unsubscribe);
                $cnt_env++;
                if ($cnt_env == 1) {
                    //**enviar_email_2("brayan.desteco@gmail.com", $asunto, $contenido_correo . $cont_unsubscribe);echo "TEST ENVIADO";exit;
                }
            }
        }
