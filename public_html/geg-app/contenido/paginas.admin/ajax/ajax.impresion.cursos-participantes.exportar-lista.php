...
if (isset_administrador() || isset_get('k3y74ue8')) {
    ...
    if ($curso['imagen'] !== '') {
        $url_imagen_del_curso = "https://www.infosicoes.com/paginas/" . $curso['imagen'] . ".size=4.img";
    } else {
                    ...
                    if ($sw_data_report_regpago) {
                        ...
                        <td>
                            ...
                            if($paydata_id_administrador!=='0'){
                                ...
                                $rqdarp2 = mysql_fetch_array($rqdarp1);
                        ...
                        <td>
                            ...
                            if ($id_modo_de_registro == '1' || $id_modo_de_registro == '0') {
                                ...
                                if ($data_registro['id_administrador'] == '0') {
                                    echo "<span style='font-size:8pt;'>Sin datos del registrador</span>";
                                } else {
