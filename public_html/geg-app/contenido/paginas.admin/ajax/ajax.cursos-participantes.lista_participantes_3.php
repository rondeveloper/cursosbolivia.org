    ...
    <table class="table users-table table-condensed table-hover">
        <thead>
            <tr>
                ...
                <th class="visible-lgNOT" style="padding-top: 2px;padding-bottom: 2px;width:100px;"> 
                ...
                <tr id="ajaxbox-tr-participante-<?php echo $participante['id']; ?>">
                    ...
                    <td class="visible-lgNOT">
                        <div style="width: 90px;float: right;">
                            ...
                            ?>
                            <a data-toggle="modal" data-target="#MODAL-datos-registro" onclick="datos_registro(<?php echo $participante['id']; ?>);" class="btn btn-xs btn-default active">R</a>
                            <?php
                            if ($sw_habilitacion_procesos) {
                                ?>
                                &nbsp         
