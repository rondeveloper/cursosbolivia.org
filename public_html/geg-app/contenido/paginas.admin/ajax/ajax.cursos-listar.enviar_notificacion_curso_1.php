...
switch ($modo_envio) {
    ...
    if($curso['id_modalidad'] == '3'){
        ...
        //*$rqdn1 = query("SELECT id,token FROM cursos_suscnav WHERE estado='1' AND id_departamento IN ('0','$id_departamento') AND id NOT IN (select id_tokensusc from cursos_rel_notifsuscpush where id_curso='$id_curso' and fecha_envio=CURDATE() ) $qr_bloque ORDER BY id DESC ");
        ...
        while ($rqdn2 = mysql_fetch_array($rqdn1)) {
            ...
            */
            ...
            /* registro de envio */
            query("INSERT INTO cursos_rel_notifsuscpush (id_curso,id_tokensusc,fecha_envio,data) VALUES ('$id_curso','$id_tokensusc','$fecha_envio','$data_mcast') ");
