...
$departamento = mysql_fetch_array($rqdc1);

/* imagen */
if ($id_departamento == '0' || $id_departamento == '10') {
    $url_img_curso = "contenido/imagenes/departamentos/bolivia.jpg";
    $nombre_departamento = 'Toda Bolivia';
    $qr_departamento = "";
} else {
    $url_img_curso = "contenido/imagenes/departamentos/" . $departamento['imagen'];
...
$qr_modalidad = " AND id_modalidad<>'2' ";
