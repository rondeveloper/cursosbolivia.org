...
if (isset_administrador()) {
    ...
    $cnt_participantes = mysql_num_rows($rqcp1);
        ...
        <ul>
           ...
           '1'
                ...
                <li style='font-size: 15pt !important;padding-bottom: 7pt;'>
                    <?php echo trim($rqcp2['prefijo'] . ' ' . $rqcp2['nombres'] . ' ' . $rqcp2['apellidos']); ?> -> </b> <button onclick="window.open('http://cursos.bo/contenido/librerias/fpdf/tutorial/cupon-infosicoes.php?id_cupon=<?php echo $id_cupon; ?>&id_participante=<?php echo $id_participante; ?>', 'popup', 'width=700,height=500');" class="btn btn-default btn-xs">IMPRIMIR CUP&Oacute;N</button>
                </li>
                <?php
            }
            ?>
    ...
    <button onclick="window.open('http://cursos.bo/contenido/librerias/fpdf/tutorial/cupon-infosicoes.php?id_cupon=<?php echo $id_cupon; ?>&id_curso=<?php echo $id_curso; ?>', 'popup', 'width=700,height=500');" class="btn btn-info active btn-block">IMPRIMIR CUP&Oacute;NES</button>
