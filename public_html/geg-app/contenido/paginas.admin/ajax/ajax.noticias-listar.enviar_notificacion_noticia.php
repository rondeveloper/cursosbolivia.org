...
header('Access-Control-Allow-Origin: https://cursos.bo');
...
/* imagen */
$url_img_noticia = $dominio . "contenido/imagenes/noticias/" . $noticia['imagen'] . "";

/* cont correo a enviar */
$contenido_correo = "<h2 style='text-align:center;background:#31b312;color:#FFF;border-radius:5px;padding:5px;'>".utf8_decode($data_nombre_noticia)."</h2>";
$contenido_correo .= "<center><a href='https://cursos.bo/$titulo_identificador_noticia.html'><img style='width:230px;padding:1px;border:1px solid gray;border-radius:5px;background:#31b312;' src='https://cursos.bo/contenido/alt/logotipo-v3.png'/></a></center>";
...
switch ($modo_envio) {
    ...
    case 'pushnav':
        ...
        $arrNotificationMessage = array(
            ...
            'click_action' => "https://cursos.bo/$titulo_identificador_noticia.html",
            'url' => "https://cursos.bo/$titulo_identificador_noticia.html",
...
/*
function fecha_noticia_D_d_m($fecha) {
    $dias = array("Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado");
    $nombredia = $dias[date("w", strtotime($fecha))];
    $dia = date("d", strtotime($fecha));
    $meses = array("none", "Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre");
