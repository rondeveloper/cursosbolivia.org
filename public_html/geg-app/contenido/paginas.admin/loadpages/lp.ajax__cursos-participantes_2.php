    ...
    <div class="col-md-12" style="padding-left: 0px;">
        <h4 style="margin: 0px;">
            ...
            if ($id_modalidad_curso == '2' || $id_modalidad_curso == '3') {
                ...
                ?>
                <b class="btn btn-xs btn-default pull-right" data-toggle="collapse" data-target="#COLLAPSE-cvir"><?php echo $cnt_cursos_virtuales; ?> C-Vir</b>
                <?php
            }
            ?>
        </h4>
        ...
        <div class="panelNOT">
            ...
            <div class="panel-bodyNOT" style="padding-top: 0px;<?php echo $styledisplay_addparticipante; ?>" id="div-add-participante">
                <form id="form-agrega-participante" name="form_add_participante">
                    <div class="panel-body" style="background: #f1f1f1;border: 1px solid #3498db;border-radius: 5px;margin-bottom: 7px;">
...
<div id="MODAL-avance-cvirtual" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">AVANCE EN EL CURSO VIRTUAL</h4>
            </div>
            <div class="modal-body">
