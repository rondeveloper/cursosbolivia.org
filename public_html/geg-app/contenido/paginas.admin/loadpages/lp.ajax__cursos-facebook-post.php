...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="">
            <iframe src="https://cursos.bo/contenido/librerias/editor-fb/index.php" style="width: 100%;height:250px;border: 0px;overflow: hidden;"></iframe>
        </div>
        <?php
        $rqdcl1 = query("SELECT id FROM cursos WHERE estado='1' ORDER BY id_ciudad ASC,fecha ASC");
        $title_nombre_ciudad = '';
        while ($rqdcl2 = mysql_fetch_array($rqdcl1)) {
            $id_curso = $rqdcl2['id'];
            ...
            if ($title_nombre_ciudad !== $nombre_ciudad) {
                ...
                echo "<br/><h3>$title_nombre_ciudad</h3>";
            }
