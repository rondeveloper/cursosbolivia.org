...
if ($rqc2['imagen'] !== '') {
    if (file_exists("../../imagenes/paginas/" . $rqc2['imagen'])) {
        $url_imagen_del_curso = "https://cursos.bo/contenido/imagenes/paginas/" . $rqc2['imagen'];
    } else {
    ...
    <div class="col-mod-12">
        ...
        <div class="form-group hiddn-minibar pull-right">
            <div class="hidden-sm">
                ...
                ?>
                <a href="<?php echo $titulo_identificador_del_curso; ?>.html" target="_blank" class="btn btn-sm btn-info active"><i class="fa fa-eye"></i> VISUALIZAR</a>
                &nbsp;|&nbsp;
                <a href="cursos-editar/<?php echo $id_curso; ?>.adm" class="btn btn-sm btn-info active"><i class="fa fa-edit"></i> EDITAR</a>
                &nbsp;
            </div>
            <div class="hidden-md">
                <a href="<?php echo $titulo_identificador_del_curso; ?>.html" target="_blank" class="btn btn-sm btn-info active" title="VISUALIZAR CURSO"><i class="fa fa-eye"></i></a>
                &nbsp;|&nbsp;
    ...
    <div class="col-md-12" style="padding-left: 0px;">
        <h4 style="margin: 0px;">
            ...
            if ($id_modalidad_curso == '2' || $id_modalidad_curso == '3') {
                ...
                $cnt_cursos_virtuales = mysql_num_rows($rqdcv1);
                ?>
    ...
    while ($rqdcv2 = mysql_fetch_array($rqdcv1)) {
        ...
        <div class="row" style='color: #484848;font-size: 8pt;clear: both;background: #bae4ff;border-radius: 5px;padding: 5px;margin-top: 5px;border: 1px solid #79b1c3;'>
            ...
            <div class="col-md-4">
                ...
                <a href="https://cursos.bo/curso-online/<?php echo $rqdcv2['urltag']; ?>.html" target="_blank">https://cursos.bo/curso-online/<?php echo $rqdcv2['urltag']; ?>.html</a>
            </div>
        </div>
        <?php
    }
...
<div class="row">
    <div class="col-md-12NOT">
        <div class="panelNOT">
                ...
                <div class="col-md-6">
                    <form action="" method="post" onsubmit="return busca_participantes(<?php echo $id_curso; ?>, <?php echo $id_turno_curso; ?>, document.getElementById('inputbuscador').value);">
                        <div class="input-group col-sm-12">
                            <span class="input-group-addon" onclick="busca_participantes(<?php echo $id_curso; ?>, <?php echo $id_turno_curso; ?>, document.getElementById('inputbuscador').value);" style="cursor:pointer;"><i class="fa fa-search"></i> &nbsp; Buscar: </span>
                ...
                <div class="col-md-6">
                    <div class="text-right" style="padding:5px 0px;">
                        <a onclick="VAR_modo_de_pago = 'todos';
                                ...
                                lista_participantes_eliminados(<?php echo $id_curso; ?>, 0);" id="btnmodopago-todos" class="btnmodopago btn btn-sm active btn-info" style="font-size: 8pt;"><i class="fa fa-list"></i> TODOS </a>
                        <a onclick="VAR_modo_de_pago = 'conpago';
                                lista_participantes(<?php echo $id_curso; ?>, 0);
                                lista_participantes_eliminados(<?php echo $id_curso; ?>, 0);" id="btnmodopago-conpago" class="btnmodopago btn btn-sm btn-default" style="font-size: 8pt;"><i class="fa fa-list"></i> CON PAGO</a>
                        <a onclick="VAR_modo_de_pago = 'sinpago';
                                lista_participantes(<?php echo $id_curso; ?>, 0);
                                lista_participantes_eliminados(<?php echo $id_curso; ?>, 0);" id="btnmodopago-sinpago" class="btnmodopago btn btn-sm btn-default" style="font-size: 8pt;"><i class="fa fa-list"></i> SIN PAGO</a>
                    </div>
                    <?php
                    $sw_turnos = false;
            ...
            ?>
            <button class="btn btn-xs btn-success btn-block" data-toggle="collapse" data-target="#COLLAPSE-addparticipante"><i class="fa fa-plus"></i> AGREGAR PARTICIPANTE</button>
            <div id="COLLAPSE-addparticipante" class="collapse">
                <div class="panel-bodyNOT" style="padding-top: 0px;<?php echo $styledisplay_addparticipante; ?>" id="div-add-participante">
                    <form id="form-agrega-participante" name="form_add_participante">
                        <div class="panel-body" style="background: #f1f1f1;border: 1px solid #bdd69d;border-radius: 5px;margin-bottom: 7px;">
                            ...
                            <div class="row">
                                <div class="col-md-1 text-right">
                                    ...
                                    $costoe2_curso = $rqc2['costo_e2'];
                                    ?>                                    
                                    <select name="monto_pago" class="form-control" id="data_mpago">
    ...
    <!--                                    <input type="number" name="monto_pago" class="form-control" placeholder="Monto..." required="" value="<?php echo $costo_curso; ?>"/>-->
                                ...
                                <div class="col-md-3">
                                    <select name="modo_pago" class="form-control" id="data_fpago">
                                ...
                                <div class="col-md-3"><input type="text" name="celular" id="f-celular" class="form-control" placeholder="Celular" autocomplete="off"/></div>
                                <div class="col-md-1">
                                    <?php
                                    if ($sw_turnos) {
                                        ?>
                                ...
                                <div class="col-md-1">
                                    <b data-toggle="collapse" data-target="#COLLAPSE-3row" class="btn btn-block btn-default collapsed">3ra Fila</b>
                                </div>
                            </div>

                            <div id="COLLAPSE-3row" class="row collapse">
                                <div class="col-md-1 text-right">
                                    <input type="text" name="numeracion" class="form-control" id="numeracion-nuevo-participante" value="<?php echo $inicio_numeracion; ?>" />
                                </div>
                                <div class="col-md-3">
                                    <input type="text" name="razon_social" class="form-control" placeholder="Razon Social" id="f-raz" autocomplete="off" onkeyup="this.value = this.value.toUpperCase()"/>
                                </div>
                                <div class="col-md-3">
                                    <input type="text" name="nit" class="form-control" placeholder="NIT" id="f-nit" autocomplete="off" onkeyup="this.value = this.value.toUpperCase()"/>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <b class="btn btn-default btn-xs pull-right" title="Agregar participantes mediante CSV" data-toggle="modal" data-target="#MODAL-agregar_participantes_csv"><i class="fa fa-upload"></i></b>
                                </div>
                                <div class="hidden-md">
                                    <br/>
...
<script>
    function imprimir_tres_certificados(dat) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.aux.cursos-participantes.imprimir_tres_certificados.php',
            data: {id_curso: <?php echo $id_curso; ?>, ids: dat},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
...
<script>
    function visualizar_certificado_digital(dat) {
        if (dat > 0) {
            $.ajax({
                url: 'contenido/paginas.admin/ajax/ajax.aux.cursos-participantes.visualizar_certificado_digital.php',
                data: {dat: dat},
                type: 'POST',
                dataType: 'html',
                success: function(data) {
...
<script>
    function emite_certificados_multiple(id_certificado, id_curso, modo) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-participantes.emite_certificados_multiple.php',
...
<script>
    function emision_cupones_infosicoes() {
        ...
        $("#AJAXCONTENT-emite_certificados_multiple").html('<img src="contenido/imagenes/images/load_ajax.gif"/>');
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.modal.cursos-participantes.emision_multiple_cupones_infosicoes.php',
...
<script>
    function emision_cupones_infosicoes_p2() {
        ...
        $("#AJAXCONTENT-emite_certificados_multiple").html('<img src="contenido/imagenes/images/load_ajax.gif"/>');
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.modal.cursos-participantes.emision_multiple_cupones_infosicoes_p2.php',
            data: {dat: ids.join(','), id_curso: id_curso},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
...
<script>
    function acceso_cursos_virtuales(id_participante) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-participantes.acceso_cursos_virtuales.php',
...
<script>
    function edita_certificado_individual(id_emision_certificado) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-participantes.edita_certificado_individual.php',
...
<script>
    function proceso_envio_de_certificado(id_emision_certificado) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-participantes.proceso_envio_de_certificado.php',
            data: {id_emision_certificado: id_emision_certificado},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
...
<script>
    ...
    function habilita_participante_cvirtual_p1(id_participante) {
        ...
        $("#ajaxloading-habilita_participante_p1").html(text__loading_dos);
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-participantes.habilita_participante_cvirtual_p1.php',
            data: {id_participante: id_participante},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
    ...
    function elimina_participante_cvirtual_p1(id_participante) {
        ...
        $("#ajaxloading-elimina_participante_p1").html(text__loading_dos);
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-participantes.elimina_participante_cvirtual_p1.php',
            data: {id_participante: id_participante},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
...
<script>
    function reprogramacion_de_curso(id_participante) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-participantes.reprogramacion_de_curso.php',
            data: {id_participante: id_participante},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
...
<script>
    function reprogramacion_de_curso_p2() {
        ...
        $("#TR-AJAXBOX-reprogramacion_de_curso").html('Cargando...');
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-participantes.reprogramacion_de_curso_p2.php',
            data: form,
            type: 'POST',
            dataType: 'html',
            success: function(data) {
