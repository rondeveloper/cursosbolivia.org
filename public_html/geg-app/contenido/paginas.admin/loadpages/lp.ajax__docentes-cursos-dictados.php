...
if ($sw_busqueda) {
    ...
    $resultado3b = mysql_fetch_array($resultado3);
        ...
        <div class="col-md-5">
            <div style="padding: 10px 0px 10px 30px;
                 ...
                 while ($curso = mysql_fetch_array($resultado1)) {
                     ...
                     $rqcpc2 = mysql_fetch_array($rqcpc1);
...
<script>
    function pago_curso(id_curso, id_docente) {
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.docentes-cursos-dictados.pago_curso.php',
...
<script>
    function edita_horas(id_curso) {
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.docentes-cursos-dictados.edita_horas_p1.php',
