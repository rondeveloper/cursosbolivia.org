...
if(isset_post('agregar-grupo')){
    ...
    $id_whatsapp_grupo = mysql_insert_id();
...
<!--                                <th class="visible-lgNOT" style="font-size:10pt;width:100px;">Img.</th>-->
                        ...
                        <tbody>
                            <?php
                            $cnt = 1;
                            while ($departamento = mysql_fetch_array($resultado1)) {
    ...
    <!--                                    <td class="visible-lgNOT">
                                    ...
                                    <td class="visible-lgNOT">
                                        <?php
                                        /* url_corta */
                                        $url_corta = 'https://cursos.bo/cursos-en-' . $departamento['titulo_identificador'] . '.html';
                                        $url_corta_2 = 'https://cursos.bo/' . strtolower($departamento['cod']) . '/';
                                    ...
                                    <td class="visible-lgNOT">
                                        ...
                                        $rqcenv2 = mysql_fetch_array($rqcenv1);
                                        ...
                                        $rqcenp2 = mysql_fetch_array($rqcenp1);
                                    ...
                                    <td class="visible-lgNOT text-center">
                                        <?php
                                        $url_imgbanner = 'contenido/imagenes/banners/1528991771banner-uno.png';
                                        if ($departamento['img_banner'] !== '') {
                                            $url_imgbanner = 'contenido/imagenes/departamentos/' . $departamento['img_banner'];
                                        }
                                        ?>
    ...
    <!--                                    <td class="visible-lgNOT">
                                        <img src="<?php echo "contenido/imagenes/departamentos/bolivia.jpg"; ?>" style="height:70px;width:70px;overflow:hidden;border-radius: 7px;opacity: .8;"/>
                                    </td>-->
                                    <td class="visible-lgNOT" style="vertical-align: middle;">
                                    ...
                                    <td class="visible-lgNOT">
                                        <?php
                                        /* url_corta */
                                        $url_corta = 'https://cursos.bo/cursos-en-bolivia.html';
                                        echo "<input type='text' class='form-control' value='" . $url_corta . "'/>";
                                        ?>
                                    </td>
                                    <td class="visible-lgNOT">
                            ...
                            if (mysql_num_rows($rqdcv1)>0) {
                                ...
                                <tr>
                                    ...
                                    <td class="visible-lgNOT">
                                        <?php
                                        /* url_corta */
                                        $url_corta = 'https://cursos.bo/cursos-virtuales.html';
                                        echo "<input type='text' class='form-control' value='" . $url_corta . "'/>";
                                        ?>
                                    </td>
                                    <td class="visible-lgNOT">
...
<script>
    function notificar_cursos(id_departamento) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-departamentos.notificar_cursos.php',
...
<script>
    function actualiza_segmento_de_notificacion() {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-departamentos.actualiza_segmento_de_notificacion.php',
            data: arraydata,
            type: 'POST',
            dataType: 'html',
            success: function(data) {
...
<script>
    function enviar_notificacion_cursos(dat, bloque) {
        ...
        var arraydata = $("#form-segmento-notificacion").serialize();
        $.ajax({
            url: 'https://www.cursos.bo/contenido/paginas.admin/ajax/ajax.cursos-departamentos.enviar_notificacion_cursos.php?modenv=' + dat + '&bloque=' + bloque + '&ahdmd=<?php echo base64_encode($id_administrador); ?>&title=' + encodeURI(title),
            data: arraydata,
            type: 'POST',
            dataType: 'html',
            success: function(data) {
...
<script>
    function historial_curso(id_departamento) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-departamentos.historial_departamento.php',
            data: {id_departamento: id_departamento},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
...
<script>
    function grupos_whatsapp(id_departamento) {
        $("#AJAXCONTENT-show_metricas").html('Cargando...');
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-departamentos.grupos_whatsapp.php',
            data: {id_departamento: id_departamento},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
...
<script>
    function fanpage_facebook(id_departamento) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-departamentos.fanpage_facebook.php',
            data: {id_departamento: id_departamento},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
