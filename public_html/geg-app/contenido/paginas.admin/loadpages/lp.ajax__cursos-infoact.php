...
if (isset($get[5])) {
    ...
    if($id_departamento=='10'){
        $qr_departamento = "";
        $htm_titlepage = "CURSOS VIRTUTALES : <a href='https://cursos.bo/cursos-virtuales.html' style='font-size: 14pt;font-weight:bold;' target='_blank' class='hidden-sm'>https://cursos.bo/cursos-virtuales.html</a>";
...
(c.id_cuenta_bancaria)dr_id_cuenta_bancaria
";
                            ...
                            while ($curso = mysql_fetch_array($resultado1)) {
                                ...
                                <tr class="<?php echo $tr_class; ?>">
                                    ...
                                    <td class="">
                                        ...
                                        /* banco */
                                        $rqdtcb1 = query("SELECT * FROM cuentas_de_banco WHERE id='" . $curso['dr_id_cuenta_bancaria'] . "' ORDER BY id ASC ");
