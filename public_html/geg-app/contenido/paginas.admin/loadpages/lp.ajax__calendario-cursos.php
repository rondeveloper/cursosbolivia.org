...
<div class="row">
    <div class="col-mod-12">
        <ul class="breadcrumb">
            ...
            <li class="active">Calendario de cursos</li>
        </ul>
        <!--        <div class="form-group hiddn-minibar pull-right">
                    <a href="cursos-crear.adm" class='btn btn-success active'> <i class='fa fa-plus'></i> AGREGAR CURSO</a>
                </div>-->
        <h3 class="page-header"> CALENDARIO DE CURSOS <i class="fa fa-info-circle animated bounceInDown show-info"></i> </h3>
        ...
        <div style="background: #eaeaea;
            ...
            <form action="" method="post" id="FORM-listado">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group col-sm-12">
                            <span class="input-group-addon"><i class="fa fa-search"></i> &nbsp; Mes: </span>
                            <select class="form-control" name="mes" id="fnp_mes">
                                <?php
                                ...
                                for($i=1;$i<=12;$i++){
                                    ...
                                    echo "<option value='$i' $selected>" . $array_meses[$i] . "</option>";
                                }
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="input-group col-sm-12">
                            <span class="input-group-addon"><i class="fa fa-search"></i> &nbsp; A&ntilde;o: </span>
                            <input type="number" name="anio" min='2017' value="<?php echo date("Y"); ?>" id="fnp_anio" class="form-control" placeholder="A&ntilde;o..."/>
                        </div>
                    </div>
                </div>
...
<script>
    function listado() {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.calendario-cursos.listado.php',
            data: form,
            type: 'POST',
            dataType: 'html',
