...
if (isset_post('agregar-whatsapp_numero')) {
    ...
    if (mysql_num_rows($rv1) == 0) {
        ...
        query("INSERT INTO whatsapp_numeros("
                ...
                . "'$estado'"
                . " ) ");
        $id_whatsapp_numero = mysql_insert_id();
...
$resultado1 = query("SELECT * FROM whatsapp_numeros WHERE estado IN ('1','2') $qr_busqueda ORDER BY id ASC LIMIT $start,$registros_a_mostrar");
                        ...
                        <tbody>
                            ...
                            while ($producto = mysql_fetch_array($resultado1)) {
                                ...
                                <tr>
                                    ...
                                    <td>                                   
                                        <a data-toggle="modal" data-target="#MODAL-editar-whatsapp_numero-<?php echo $producto['id']; ?>" title="Editar">
                                        ...
                                        &nbsp;|&nbsp;
                                        <a data-toggle="modal" data-target="#MODAL-eliminar-whatsapp_numero-<?php echo $producto['id']; ?>" title="">
                                            <button type="button" class="btn btn-danger active"><i class="fa fa-times"></i></button>
                                        </a>

                                        <!-- Modal -->
                                        <div id="MODAL-editar-whatsapp_numero-<?php echo $producto['id']; ?>" class="modal modal-info fade" role="dialog">
                                                        ...
                                                        <div class="panel panel-default">
                                                            <form action="" method="post">
                                                                ...
                                                                <div class="panel-footer">
                                                                    <input type="hidden" name="id_whatsapp_numero" value="<?php echo $producto['id']; ?>"/>
                                        ...
                                        <!-- Modal -->
                                        <div id="MODAL-eliminar-whatsapp_numero-<?php echo $producto['id']; ?>" class="modal modal-info fade" role="dialog">
                                            <div class="modal-dialog">
                                                <!-- Modal content-->
                                                <div class="modal-content">
                                                    <div class="modal-header">
