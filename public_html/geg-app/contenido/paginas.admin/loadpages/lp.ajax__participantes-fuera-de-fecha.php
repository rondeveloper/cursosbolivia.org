                        ...
                        <tbody>
                            ...
                            while ($producto = mysql_fetch_array($resultado1)) {
                                ...
                                <tr>
                                    ...
                                    <td class="visible-lgNOT">
                                        <?php
                                        if ($producto['dr_monto_pago'] !== '' && $producto['dr_modo_pago'] !== '') {
...
function generar_reporte(data){
    var url = 'https://cursos.bo/contenido/paginas.admin/ajax/ajax.impresion.participantes-fuera-de-fecha.exportar-lista.php?data='+data;
