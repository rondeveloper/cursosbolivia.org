                                ...
                                <tr>
                                    ...
                                    <td class="visible-lgNOT">
                                        ...
                                        if ($producto['estado'] == '1') {
                                            ...
                                            $curso_a = mysql_fetch_array($rqdca1);
                                            ?>
                                    ...
                                    <td class="visible-lgNOT" style="width:120px;">
                                        ...
                                        if ($curso['estado'] == '1' || $curso['estado'] == '2') {
                                            ?>
                                            <a onclick="window.open('<?php echo $dominio . "contenido/librerias/fpdf/tutorial/ficha-reprogramacion.php?codigo=" . $producto['codigo']; ?>', 'popup', 'width=700,height=500');" class="btn btn-primary btn-xs active">
...
<script>
    function proceso_asignacion(id_reprogramacion) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-reprogramacion-participantes.proceso_asignacion.php',
...
<script>
    function asignar_asistencia(id_reprogramacion) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-reprogramacion-participantes.asignar_asistencia.php',
