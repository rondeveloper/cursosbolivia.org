            ...
            <div class="panel-bodyNOT">
                <div class="table-responsive">
                    <table class="table users-table table-condensed table-hover table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
                            while ($material = mysql_fetch_array($resultado1)) {
                                $tr_class = '';
                                /* curso suspendido */
                                ...
                                <tr class="<?php echo $tr_class; ?>">
                                    ...
                                    <td class="visible-lgNOT">
                                        ...
                                        if ($nivel_administrador == '1') {
                                            /* url_ingreso */
                                            $url_corta = 'https://cursos.bo/material-digital/' . $material['id'] . '/' . md5(md5($material['id'] . '-168')) . '.html';
...
<script>
    function cambiar_estado_curso(id_curso, estado) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-materiales.cambiar_estado_curso.php',
...
<script>
    function historial_curso(id_curso) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-materiales.historial_curso.php',
...
<script>
    function cursos_asociados(id_curso) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-materiales.cursos_asociados.php',
            data: {id_curso: id_curso},
            type: 'POST',
            dataType: 'html',
            success: function (data) {
...
<script>
    function mostrar_archivos(id_material) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-material.mostrar_archivos.php',
...
<script>
    function editar_material(id_material) {
        ...
        $.ajax({
            url: 'contenido/paginas.admin/ajax/ajax.cursos-material.editar_material.php',
            data: {id_material: id_material},
            type: 'POST',
            dataType: 'html',
            success: function (data) {
