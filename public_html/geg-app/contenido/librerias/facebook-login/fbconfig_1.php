...
//    $_SESSION['EMAIL'] = $femail;
    ...
    if (mysql_num_rows($rqd1) > 0) {
        ...
        query("INSERT INTO cursos_usuarios (nombres,email,password,fb_id,fb_url,fb_email,fb_name,fecha_registro,estado) VALUES ('$displayname_google','$email_usuario','$password','$id_user_rs','$url_google','$email_usuario','$displayname_google','$fecha_registro','1') ");
