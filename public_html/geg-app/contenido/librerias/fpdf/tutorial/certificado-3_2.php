...
$rqdpc1 = query("SELECT nombres,apellidos,prefijo,cnt_impresion_certificados,id_curso FROM cursos_participantes WHERE id='".$rqe2['id_participante']."' ORDER BY id DESC limit 1 ");
