...
$pdf->SetX(100);
$pdf->SetFont('Arial', '', 12);
$pdf->Cell(0, 0, "Fecha: " . date("d/m/Y",strtotime($fecha_curso)), 0, 0, 'L');
...
$pdf->SetX(100);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(0, 0, "Consta la legalización de la copia al reverso de esta hoja con los datos ingresados en el codigo QR conforme a los", 0, 0, 'L');
$pdf->SetY(265);
$pdf->SetX(100);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(0, 0, "registros originales de Cursos.BO, emisión de copia legalizada en fecha: ".date("d/m/Y"), 0, 0, 'L');
