...
$rqce1 = query("SELECT certificado_id FROM cursos_emisiones_certificados WHERE id IN (select $txt_id_emision_certificado from cursos_participantes where id in($id_participantes) ) ORDER BY id ASC limit 100 ");
...
//$pdf->Cell(0, 30, 'Profesionales, Técnicos y Consultores", con una carga horaria de 8 horas.', 0, 0, 'C');
    ...
    $pdf->SetY(-100);
    /* codigo QR */
    $pdf->Image($file_qr_certificado, 685, 510, 95, 95);
}
