...
//$pdf->Cell(0, 30, 'Profesionales, Técnicos y Consultores", con una carga horaria de 8 horas.', 0, 0, 'C');
    ...
    $pdf->SetY(190);
    $pdf->SetX(25);
    $pdf->MultiCell(550, 14, 'Este cupón constituye un porcentaje de descuento para '.ucwords(strtolower($cont_nomuser)).' en algún curso habilitado a realizarse en próximas fechas en la plataforma cursos.bo', 0, 'L');
