...
// Título
$pdf->Cell(0, 80, 'CERTIFICADO DE PARTICIPACION', 0, 0, 'C');
// Salto de línea
$pdf->Ln(4);
...
$pdf->Cell(0, 115, 'LUCIA ESTRADA ARTEAGA', 0, 0, 'C');
$pdf->Ln(4);

//datos certificado
$pdf->SetFont('Arial', '', 12);
$pdf->SetTextColor(30, 30, 30);
$pdf->Cell(0, 135, 'Por cuanto se reconoce que completo satisfactoriamente el curso de capacitación:', 0, 0, 'C');
$pdf->Ln(4);
...
$pdf->Cell(0, 150, 'Realizado en Potosí, Bolivia a los 26 dias del mes de Abril de 2017', 0, 0, 'C');
