...
$rqce1 = query("SELECT certificado_id FROM cursos_emisiones_certificados WHERE id IN (select id_emision_certificado from rel_participante_modelocertificado where id_modelo_certificado in ($ids_modelos_certificado) and id_participante in($id_participantes) ) ORDER BY id DESC limit 100 ");
