...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  'Verificar mi respuesta!',
                nextQuestionText: 'Siguiente &raquo;',
                backButtonText: '',
                completeQuizText: '',
                tryAgainText: '',
                questionCountText: 'Pregunta %current de %total',
                preventUnansweredText: 'Debes seleccionar al menos una pregunta.',
        ...
        // Estado de Progressbar
        var progresssbarState = 0;
        ...
        plugin.method = {
                    ...
                    if (questions.hasOwnProperty(i)) {
                        ...
                        for (i in answers) {
                            if (answers.hasOwnProperty(i)) {
                                ...
                                var inputOptionLabel = '<label for="' + optionId + '" class="label-option-q"> <input id="' + optionId + '" name="' + inputName +
                                            '" type="' + inputType + '" /> '+' &nbsp; ' + answer.option + '</label>';

                                var answerContent = $('<li></li>')
                                    .append(inputOptionLabel);
            ...
            nextQuestion: function(nextButton, options) {
                ...
                /* my code: incrementa progressbar*/
                var increment_progressbar = 100/questionCount;
                progresssbarState += increment_progressbar;
                $("#pro-bar").css("width",progresssbarState+"%");
            },
            ...
            completeQuiz: function(options) {
                ...
                if (plugin.config.disableScore) {
                    ...
                    sendScoreToServer(displayScore,questionCount);
                }
