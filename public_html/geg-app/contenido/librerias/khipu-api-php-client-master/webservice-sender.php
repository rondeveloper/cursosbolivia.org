...
$expires_date->setDate(2017, 11, 05);

$kh = new Khipu\Client\PaymentsApi($cl);

$title = "Curso Infosicoes C00451";
...
try {
    ...
    echo "<br/><b style='color:green;'>PAGO REGISTRADO</b><br/>";
    ...
    echo "Token de Notificacion : ".$notification_token."<br/>";
    echo "ID de transaccion : ".$transaction_id."<br/>";
    echo "<br/>";
    echo "<br/>";
    echo $r2;
    echo "<hr/>";
