...
$organizador = mysql_fetch_array($rqdor1);
?>
...
<!--                                <div class="col-xs-6 col-sm-6 col-md-6 Titulo_texto">N.I.T.</div>
                ...
                <div class="panel show">
                    <p class="Titulo_texto1"> </p>
                    <?php
                    $rc1 = query("SELECT c.titulo,c.titulo_identificador,c.imagen,c.fecha FROM cursos c WHERE estado='1' AND sw_flag_cursosbo='1' AND id_organizador='" . $organizador['id'] . "' ORDER BY fecha DESC ");
...
<!--                                <div class="tit_duracion hidden-xs">FECHA</div>-->
                                <div class="tit_horas">VIRTUAL<?php //echo $fecha_de_curso; ?></div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    Para poder realizar la inscripci&oacute;n al curso, es necesario que ingreses a tu cuenta en la plataforma <b>Cursos.BO</b>
                </p>
                <div>
                    <div class="boxForm">
