...
<div class="wrapsemibox">
    <section class="container">
        <div class="row" style="background: #f6f5f5;">
            ...
            <div class="col-md-12" style="background:#FFF;padding: 0px 15px;">
                ...
                if (mysql_num_rows($rqcp1) == 0) {
                    ...
                    <table class='table table-striped table-bordered'>
                        ...
                        while ($rqcu2 = mysql_fetch_array($rqcp1)) {
                            ...
                            <tr>
                                <td class="hidden-xs">
                                    <?php echo strtoupper($rqcu2['certificado_id']); ?>
                                </td>
                                <td>
                                    <?php echo $rqcu2['codigo'].'<br>'.utf8_encode($rqcu2['texto_qr']); ?>
                                </td>
                                <td class="hidden-xs">
                                ...
                                <td>
                                    <b class="btn btn-danger btn-xs" onclick="window.open('https://gegbolivia.cursos.bo/contenido/librerias/fpdf/tutorial/certificado.php?data=<?php echo strtoupper($rqcu2['certificado_id']); ?>', 'popup', 'width=700,height=500');">
