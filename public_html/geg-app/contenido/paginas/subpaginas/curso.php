...
$htm_whatsapp = "<div style='text-align:center;'><a href='https://api.whatsapp.com/send?phone=" . $curso['whats_numero'] . "&amp;text=" . str_replace("'", "", str_replace(' ', '%20', str_replace('&', 'y', $curso['whats_mensaje']))) . "'><img src='https://www.infosicoes.com/contenido/imagenes/paginas/1510747809whatsapp__.png' style='height:120px;'/></a></div>";
        ...
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <?php 
                                    $url_corta = 'https://cursos.bo/' . abs((int) $id_curso - 1000) . '/';
                                    ?>
                                ...
                                <div class="row">
                                    ...
                                    ?>
                                    <div class="col-md-9 col-xs-9 Titulo_texto1"> : &nbsp;<a href='<?php echo 'https://wa.me/'.$cel_wamsm.'?text='.$mensaje_wamsm_predeternimado; ?>' target="_blank"><?php echo 'https://wa.me/'.$cel_wamsm; ?></a></div>
                                    <div style="height:25px"></div>
                                </div>
                                <?php if ($curso['id_modalidad'] !== '2' && $curso['id_modalidad'] !== '3') { ?>
                                    <div class="row">
                            ...
                            if ($curso['estado'] !== '0') {
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 col-xs-9 Titulo_texto1" style="padding-top: 5px;">: GRATUITO</div> 
                                        <div style="height:25px"></div>
                                    </div>
                                    <?php
                                            }
                                    ...
                                    <?php
                                        if ((int) $costo > 0) {
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9 col-xs-9 Titulo_texto1">
                                                    <strong>:</strong>&nbsp; <?php echo $rqdtcb2['banco']; ?> cuenta <?php echo $rqdtcb2['numero_cuenta']; ?><br/> :&nbsp; Titular <?php echo $rqdtcb2['titular']; ?>
                                                    <br/>
            ...
            <div class="col-md-3">
                ...
                <div style=" background-color:#F6F6F6; border-radius:7px; padding:7px 12px 10px 12px; color:#000">
                    ...
                    $rqdor2 = mysql_fetch_array($rqdor1);
                    ?>
                    ...
                    <p class=" text-right">
                        ...
                        if ($curso['estado'] == '1') {
                            if (!isset_usuario() && false) {
                                ...
                                ?>
                                <a href="registro-curso/<?php echo $titulo_identificador_curso; ?>.html" class="btn btn-lg btn-block btn-success">
                                    <i class="fa fa-thumbs-o-up"></i> Inscribirme
                                </a>
                                <?php
                            }
                ...
                if ($curso['estado'] !== '0') {
                    ...
                    <div style=" background-color:#F6F6F6; border-radius:7px; padding:7px 12px 10px 12px; color:#000">
                        <p class="text-center">
                            <br/>
                            <b style="font-size:30pt;color:#333; margin-top: 5px;font-weight: bold;" class="text-right"><?php echo $costo; ?> Bs</b>
                        </p>
                        <?php
                        /* precio estudiantes */
                        if ($curso['sw_fecha_e'] == '1' && (date("Y-m-d") <= $curso['fecha_e'])) {
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    Envia la informaci&oacute;n de este curso a un amigo por correo electr&oacute;nico mediante <b>Cursos.BO</b>
                </p>
                <div>
                    <div class="boxForm">
...
<script>
    ...
    function shareFacebook() {
        FB.ui({
            method: 'share',
            href: 'https://cursos.bo/<?php echo $titulo_identificador_curso; ?>.html'
        }, function(response) {
        });
    }
</script>
