...
<div class="gris">
    <section class="container container-home">
        ...
        while ($rc2 = mysql_fetch_array($rcv1)) {
            ...
            $url_pagina_curso = $rc2['url_externa'];
            //$url_pagina_curso = $dominio;
            $target_url_pagina_curso = ' target="_blank" ';
                ...
                <div class="blog-post-short">
                    <div class="img-holder">
                        <div class="bg-img-holder bx-img-curso-f1">
                            <a href="<?php echo $url_pagina_curso; ?>" <?php echo $target_url_pagina_curso; ?>>
                ...
                <div class="blog-post-short list-group-item hidden-xs">	 
                    <div class="row">
                        <div class="col-md-12 hidden-xs titulo-curso-f1">
                            <h2 class="h2-to-normal"><a href="<?php echo $url_pagina_curso; ?>" <?php echo $target_url_pagina_curso; ?> class="Enlace_Curso_Main_Titulo"><?php echo $titulo_de_curso; ?></a></h2>
                        </div>
                        <div class="col-md-12 hi hidden-sm hidden-md hidden-lg titulo-curso-f1">
                            <a href="<?php echo $url_pagina_curso; ?>" <?php echo $target_url_pagina_curso; ?> class="Enlace_Curso_Main_Cel"><?php echo $titulo_de_curso; ?></a>
                        </div>
                    </div>
                    ...
                    <div class="row hi hidden-xs ">	    	
                        <div class="blog-meta">
                            <div class="col-md-12 hi hidden-xs" align="right">
                                <a href="<?php echo $url_pagina_curso; ?>" <?php echo $target_url_pagina_curso; ?> class="buttonlink rojo btn-block"> <i class="icon-edit text-contrast"></i> INGRESAR</a>
                            </div>
                        </div>  
                    </div>
                    <div class="row hi hidden-sm hidden-md hidden-lg">	    	
                        <div class="blog-meta">
                            <div class="col-md-12 hi hidden-sm hidden-md hidden-lg" align="center">
                                <a href="<?php echo $url_pagina_curso; ?>" <?php echo $target_url_pagina_curso; ?> class="buttonlinkcel rojo"> <i class="icon-edit text-contrast"></i> Certificado</a>
                            </div>
                        </div>  
                    </div>
                </div>		
                ...
                <div class="blog-post-short list-group-item-cel hidden-sm hidden-md hidden-lg">		 
                    <div class="row">
                        <div class="col-md-12 hidden-xs">
                            <a href="<?php echo $url_pagina_curso; ?>" <?php echo $target_url_pagina_curso; ?> class="Enlace_Curso_Main_Titulo"><?php echo trim(str_replace($ciudad_curso, '', str_replace('en ' . $ciudad_curso, '', $titulo_de_curso))); ?></a>
                        </div>
                        <div class="col-md-12 hi hidden-sm hidden-md hidden-lg titulo-curso-f1">
                            <a href="<?php echo $url_pagina_curso; ?>" <?php echo $target_url_pagina_curso; ?> class="Enlace_Curso_Main_Cel"><?php echo trim(str_replace($ciudad_curso, '', str_replace('en ' . $ciudad_curso, '', $titulo_de_curso))); ?></a>
                        </div>
                    </div>
                    <div>	
                        <div class="row hi hidden-xs">	    
                        ...
                        <div class="row hi hidden-xs ">	    	
                            <div class="blog-meta">
                                ...
                                <div class="col-md-5 hi hidden-xs" align="right">
                                    <a href="<?php echo $url_pagina_curso; ?>" <?php echo $target_url_pagina_curso; ?> class="buttonlink rojo">  <i class="icon-edit text-contrast"></i> Certificado</a>
                                </div>
                            </div>  
                        </div>
                    </div>
                    <div class="row hi hidden-sm hidden-md hidden-lg toBottom">	    	
                        <div class="col-md-12 hi hidden-sm hidden-md hidden-lg">
                            <a href="<?php echo $url_pagina_curso; ?>" <?php echo $target_url_pagina_curso; ?> class="buttonlinkcel orangecel">  <i class="icon-edit text-contrast"></i>  Certificado</a>
                        </div>
                    </div>  
                </div>
                <!------------------------------------->
...
<div style="background-color:#FFF">
    <section class="container">
        ...
        <div class="box-valida-cert">
            <div class="row">
                <form action="validar-certificado.html" method="post" id="form-valida-cert">
