        ...
        <div class="row" style="background: #f6f5f5;">
            ...
            <div class="col-md-10" style="background:#FFF;padding: 0px 15px;">
                ...
                if(false){
                    ...
                    $rqv1 = query("SELECT certificado_id FROM emisiones_certificados WHERE id_usuario='$id_usuario' AND id_certificado='3' ORDER BY id DESC limit 1 ");
                    if (mysql_num_rows($rqv1)>0) {
                        ...
                        <div class="Titulo_texto1">
                            ...
                            <b>CERTIFICADO:</b>
                            <h5 style="font-size: 15pt;color: #5491af;">GSuite para la Comunicaci&oacute;n Creativa y Dise&ntilde;ador Innovador</h5>
                    ...
                    <div class="boxForm ajusta_form_contacto">
                        <b>CERTIFICADO:</b>
                        <h5 style="font-size: 20pt;">GSuite para la Comunicaci&oacute;n Creativa y Dise&ntilde;ador Innovador</h5>
                        <hr/>
                        <div class="row">
                            ...
                            <div style="background:#FFF;padding: 5px;">
                                <form action="" method="post">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                            <td>CERTIFICADO</td>
                                            <td>GSuite para la Comunicaci&oacute;n Creativa y Dise&ntilde;ador Innovador</td>
                                        </tr>
                                        <tr>
                                            <td>PROGRAMA</td>
