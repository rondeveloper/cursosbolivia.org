    ...
    <div class="panel-body" style="padding: 5px;">
        <div class="col-md-3 col-xs-3 text-left">
            ...
            if ($onlinecourse['imagen'] !== '') {
                $url_imagen = 'https://cursos.bo/cursos/' . $onlinecourse['imagen'] . '.size=4.img';
            }
            ?>
        ...
        if (isset_usuario()) {
            ...
            <div class="col-md-4 col-xs-4">
                <div class="box-datauser">
                    <img src="https://cursos.bo/contenido/imagenes/images/user.png" style="width:30px;height: 30px;"/>
                    ...
                    if (mysql_num_rows($rqdvpi1) > 0) {
                        $rqdvpi2 = mysql_fetch_array($rqdvpi1);
                        ...
                        $rqdadcv2 = mysql_fetch_array($rqdadcv1);
