...
<div class="panel">
    <div class="panel-body">
        ...
        <div class="col-md-3 col-xs-5 text-center">
            ...
            if ($curso['imagen'] !== '') {
                $url_imagen = 'https://www.infosicoes.com/paginas/' . $curso['imagen'] . '.size=4.img';
                if (file_exists('contenido/imagenes/paginas/'.$curso['imagen'])) {
                    $url_imagen = 'https://cursos.bo/paginas/' . $curso['imagen'] . '.size=4.img';
                }
            }
            ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    if (isset($id_turno) && $id_turno!=='' && $id_turno!=='0') {
                        ...
                        $rqdtt2 = mysql_fetch_array($rqdtt1);
...
<!--            </div>
            ...
            <br/>
            <a href='<?php echo $curso['titulo_identificador']; ?>.html' target='_blank' style='text-decoration:underline;'>Ver detalles del curso >></a>
        </div>
