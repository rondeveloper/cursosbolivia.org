...
if (isset($_SERVER['HTTP_X_FORWARDED_FOR']) && $_SERVER['HTTP_X_FORWARDED_FOR'] != '') {
    $ip_download = mysql_real_escape_string($_SERVER['HTTP_X_FORWARDED_FOR']);
} else {
    $ip_download = mysql_real_escape_string($_SERVER['REMOTE_ADDR']);
}
...
if (isset_get('id_curso_online')) {
    ...
    $url_referer = "https://cursos.bo/curso-online/" . $rqdcl2['urltag'] . ".html";
...
if (isset_get('id_leccion')) {
    ...
    $rqdcl2 = mysql_fetch_array($rqdcl1);
    $url_referer = "https://cursos.bo/curso-online-leccion/" . $rqdcl2['urltag'] . "/video.html";
    $name = $rqdcl2['video'];
}
