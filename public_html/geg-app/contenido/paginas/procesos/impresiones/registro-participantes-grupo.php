...
$id_curso = $rqrpc2['id_grupo'];
$rqc1 = query("SELECT *,(select nombre from ciudades where id=c.id_ciudad limit 1)ciudad FROM cursos_agrupaciones c WHERE id='$id_curso' ORDER BY id DESC limit 1 ");
...
$content_html_final .= "<div style='padding:10px 30px;'>
                <div>
                    <table style='width:100%;'>
                        ...
                        <td style='padding:5px;font-size: 9pt;'><b>Nro de cursos:</b></td><td style='padding:5px;font-size: 9pt;'>$cnt_participantes_registro curso(s)</td>
                        </tr>
...
$rqpc1 = query("SELECT DISTINCT nombres,apellidos,prefijo,celular,ci,correo FROM cursos_participantes WHERE id_proceso_registro='$id_proceso_registro' ORDER BY id DESC limit 20 ");
