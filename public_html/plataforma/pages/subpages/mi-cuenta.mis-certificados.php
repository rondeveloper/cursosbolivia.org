                    ...
                    <table class='table table-striped table-bordered'>
                        ...
                        while ($rqcu2 = fetch($rqcp1)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo $dominio_www; ?>contenido/paginas/procesos/pdfs/certificado-digital-3.php?id_certificado=<?php echo $rqcu2['certificado_id']; ?>&download=true" class="btn btn-sm btn-danger"><i class="fa fa-download"></i> DESCARGAR</a>
                                </td>
                            </tr>
                            <?php
                        }
