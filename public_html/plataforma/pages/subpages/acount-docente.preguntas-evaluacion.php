                        ...
                        while ($producto = fetch($rqmc1)) {
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    ?>
                                    <b class="btn btn-xs btn-success btn-block" style="padding-top:2px;padding-bottom:2px;background: #d1ff88;color: green;" onclick="respuesta_evaluacion(<?php echo $producto['id']; ?>)"><?php echo $num_resp; ?> respuestas</b>
                                    <br>
...
<script>
    function respuesta_evaluacion(id_pregunta) {
        $("#title-MODAL-general").html('EDICI&Oacute;N DE TAREA');
        $("#body-MODAL-general").html('Cargando...');
        $("#MODAL-general").modal('show');
        $.ajax({
            url: 'pages/ajax/ajax.acount-docente.preguntas-evaluacion.respuesta_evaluacion.php',
            data: {id_pregunta: id_pregunta},
            type: 'POST',
            dataType: 'html',
            success: function (data) {
