                    ...
                    if (!$sw_acceso_a_curso) {
                        ...
                        <div style='background:#258fad;color:#FFF;padding:10px 15px;border-bottom:5px solid #1b5b77;'>
                            ...
                            ?>
                                ...
                                <div class="row">
                                    <link href="<?php echo $dominio_www; ?>contenido/librerias/SlickQuiz-master/css/slickQuiz.css" media="screen" rel="stylesheet" type="text/css">
                                                ...
                                                <div id="slickQuiz">
                                                    ...
                                                    <div class="quizArea">
                                                        <div class="quizHeader">
                                                            ...
                                                            <a class="button startQuiz" href="#" onclick="setTimeout('finalizacion(<?php echo $minutos_habilitados; ?>)',<?php echo $minutos_habilitados; ?>*60*1000);">Empezar!</a>
                                                        </div>
                                                    ...
                                                    <script src="<?php echo $dominio_www; ?>contenido/librerias/SlickQuiz-master/js/slickQuiz-config.php?dat=<?php echo $id_onlinecourse; ?>"></script>
                                                    <script src="<?php echo $dominio_www; ?>contenido/librerias/SlickQuiz-master/js/slickQuiz.js"></script>
                                                    <script>
                                                        $('#slickQuiz').slickQuiz();
                                                    </script>
                                                </div>
...
<script>
    function sendScoreToServer(displayScore, questionCount) {
        $.ajax({
            url: 'pages/ajax/ajax.evaluacion.sendScoreToServer.php',
