...
include_once 'pages/items/item.proceso.ingresar-a-cuenta.php';

/* proceso persistencia de cuenta */
include_once 'pages/items/item.proceso.persistencia-cuenta.php';
...
$image_pagina = $___banner_principal;
...
if (isset($get[1])) {
    ...
    if (isset($get[1]) && (substr($get[1], 0, 10) == 'cursos-en-')) {
        ...
        $image_pagina = $___banner_principal;
        if ($rqdd2['img_banner'] !== '') {
            $image_pagina = $dominio_www.'contenido/imagenes/departamentos/' . $rqdd2['img_banner'];
        }
    }
    ...
    if ($get[1] == 'cursos-virtuales') {
        ...
        $image_pagina = $___banner_cursos_virtuales;
    }
...
<html lang="es" class="fa-events-icons-ready js csstransitions csstransforms csstransforms3d">
    <head>
        ...
        <base href="<?php echo $dominio_plataforma; ?>" target="_self"/>
    ...
    <body class="on" style="background: #1e5871 !important;">
        <div class="wrapbox">
            <div style='height:10px;'>&nbsp;</div>
            <nav class="navbar yamm navbar-fixed-top wowmenu tiny" role="navigation">
                <div class="container">
                    <div class="navbar-header">
                        <a class="navbar-brand logo-nav" href="<?php echo $dominio_plataforma; ?>">
                            <img src="<?php echo $dominio_www; ?>contenido/alt/logotipo-v3.png" style="height:40px;" alt="logo">
                        </a>
                    </div>
                    <?php include_once 'pages/items/item.menu_principal.php'; ?>
                </div>	
            </nav>
            <div id="mobile-header" class="hidden-md hidden-lg">
                <a id="simple-menu" class="menu-button" href="<?php echo $dominio_plataforma; ?>#sidr">Toggle menu</a>
            </div>
            <div id="sidr" class="hidden-md hidden-lg sidr left" style="transition: left 0.1s ease-in-out;">
                <a class="sidr_close pull-right" href="<?php echo $dominio_plataforma; ?>#" style="padding:5px;"><i class="icon-remove-sign text-contrast"></i></a>
                <?php include_once 'pages/items/item.menu_mobile.php'; ?>
            </div>
