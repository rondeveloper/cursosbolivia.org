...
$sw_1 = false;
if (isset_post('item-1')) {
    $sw_1 = true;
    $descripcion = 'COMPUTADORAS POSRTATILES PROFESIONAL - TIPO A';
    $unidad_medida = 'PIEZA';
    $cantidad = '50';
...
$sw_2 = false;
if (isset_post('item-2')) {
    $sw_2 = true;
    $descripcion = 'COMPUTADORAS POSRTATILES PROFESIONAL - TIPO B';
    $unidad_medida = 'PIEZA';
    $cantidad = '100';
    $precio_unitario = '16800';
    $precio_total = '1680000';
    query("INSERT INTO simulador_items 
    (id_usuario, cuce, descripcion, unidad_medida, cantidad, precio_unitario, precio_total) 
    VALUES 
    ('$id_usuario','$cuce','$descripcion','$unidad_medida','$cantidad','$precio_unitario','$precio_total')");
...
$sw_3 = false;
if (isset_post('item-3')) {
    $sw_3 = true;
    $descripcion = 'COMPUTADORAS POSRTATILES PROFESIONAL - TIPO C';
    $unidad_medida = 'PIEZA';
    $cantidad = '123';
    $precio_unitario = '15570';
    $precio_total = '1915110';
    query("INSERT INTO simulador_items 
    (id_usuario, cuce, descripcion, unidad_medida, cantidad, precio_unitario, precio_total) 
    VALUES 
    ('$id_usuario','$cuce','$descripcion','$unidad_medida','$cantidad','$precio_unitario','$precio_total')");
