                            ...
                            <div _ngcontent-vgu-c14="" class="row">
                                <div _ngcontent-vgu-c14="" class="col-lg-12 col-md-12">
                                    ...
                                    <table class="table table-bordered table-striped table-responsive">
                                        ...
                                        <?php
                                        $cnt = 1;
                                        $rqde1 = query("SELECT p.id,(u.id)dr_id_usuario,p.monto,u.nombres,u.apellidos,p.fecha,p.item FROM simulador_sigep_propuestas p INNER JOIN cursos_usuarios u ON p.id_usuario=u.id WHERE p.item=0 AND p.id_usuario='$id_usuario' ORDER BY p.id DESC ");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>25271.2</td>
                                                <td>Oferta</td>
                                                <td><?php echo number_format($rqde2['monto'], 2, '.', ','); ?></td>
