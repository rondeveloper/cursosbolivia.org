                                        ...
                                        <div _ngcontent-lkh-c21="" class="row">
                                            <div _ngcontent-lkh-c21="" class="col-12">
                                                <form action="" method="post">
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;
                                                    <a class="btn btn-info btn-sx" href="https://plataforma.cursosbolivia.org/simulador/propuestas">ACTUALIZAR DATOS</a>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div _ngcontent-jbq-c12="" class="col-lg-12 col-sm-12 col-md-12 col-12">
                                    <div _ngcontent-jbq-c12="" class="card card-default">
                                        ...
                                        <div _ngcontent-jbq-c12="" class="card-body">
                                            <?php
                                            $cnt = 1;
                                            $rqde1 = query("SELECT p.monto,u.nombres,u.apellidos,p.fecha FROM simulador_sigep_propuestas p INNER JOIN cursos_usuarios u ON p.id_usuario=u.id ORDER BY p.monto ASC,p.id ASC limit 1 ");
                                            if (num_rows($rqde1) == 0) {
                                            ...
                                            ?>
                                                <div class="text-center">
                                                    ...
                                                    <br>
                                                    <b style="font-size: 15pt;color:gray;"><?php echo date("d/m/Y H:i", strtotime($rqde2['fecha'])); ?></b>
                                                </div>
                                            <?php
                                            }
                                            ?>
                                ...
                                <div _ngcontent-jbq-c12="" class="card card-default">
                                    ...
                                    <div _ngcontent-jbq-c12="" class="card-body">
                                        ...
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <?php
                                            $cnt = 1;
                                            $rqde1 = query("SELECT p.monto,u.nombres,u.apellidos,p.fecha FROM simulador_sigep_propuestas p INNER JOIN cursos_usuarios u ON p.id_usuario=u.id ORDER BY p.id ASC ");
