<?php
if (isset($get[2]) && $get[1] == 'curso' && $curso['id']!='2348') {
?>
<style>
    .whatsappme {
        position: fixed;
    ...
    .whatsappme__box {
        ...
        padding-bottom: 60px;
        border-radius: 32px;
        background: #ede4dd url(contenido/imagenes/images/background-wapp.webp) center repeat-y;
...
<?php
$mensaje_wamsm = 'Tengo%20interes%20en%20los%20cursos';
$cel_wamsm = '59169714008';
if (isset($get[2]) && $get[1] == 'curso') {
    
    $mensaje_wamsm_predeternimado = 'Hola, tengo interes en el curso: ' . trim( $curso['titulo']);
    ...
    $rqvnw1 = query("SELECT w.numero,r.id FROM cursos_rel_cursowapnum r INNER JOIN whatsapp_numeros w ON r.id_whats_numero=w.id WHERE r.id_curso='".$curso['id']."' ORDER BY r.peso ASC limit 1 ");
    if(num_rows($rqvnw1)>0){
        $rqvnw2 = fetch($rqvnw1);
        $cel_wamsm = '591'.$rqvnw2['numero'];
        query("UPDATE cursos_rel_cursowapnum SET peso=peso+1 WHERE id='".$rqvnw2['id']."' ORDER BY id DESC limit 1 ");
    }
}
?>
<div id="box-wamsm" class="whatsappme whatsappme--left" data-settings="{&quot;telephone&quot;:&quot;34722518077&quot;,&quot;mobile_only&quot;:false,&quot;button_delay&quot;:3,&quot;whatsapp_web&quot;:false,&quot;message_text&quot;:&quot;Hola\n\u00bfEn qu\u00e9 podemos ayudarte?&quot;,&quot;message_delay&quot;:0,&quot;message_badge&quot;:true,&quot;message_send&quot;:&quot;Hola, necesito informaci\u00f3n sobre Runbenguo&quot;}">
    <div class="whatsappme__button" onclick="show_wamsm();">
        ...
        <svg class="whatsappme__button__send" viewBox="0 0 400 400" fill="none" fill-rule="evenodd" stroke="#fff" stroke-linecap="round" stroke-width="33" onclick="window.open('https://api.whatsapp.com/send?phone=<?php echo $cel_wamsm; ?>&text=<?php echo $mensaje_wamsm; ?>');">
            ...
            <div class="whatsappme__message__wrap">
                ...
                if (isset($get[2]) && $get[1] == 'curso') {
                    ...
                    <div class="whatsappme__message__content">
                        Hola
                        <br/>
                        &iquest;Quieres m&aacute;s informaci&oacute;n de este curso?
                        <br/>
                        <br/>
                        <img src="<?php echo $url_img; ?>" class="img-pag-static" style="width: 100%;"/>
                        <br/>
                        <br/>
                        Presiona el boton inferior
                    </div>
                    <?php
                } else {
                    ?>
                    <div class="whatsappme__message__content">Hola<br>&iquest;En qu&eacute; podemos ayudarte?</div>
                        <?php
                    }
                    ?>
            </div>
...
<script>
    ...
    function show_wamsm() {
        window.open('https://api.whatsapp.com/send?phone=<?php echo $cel_wamsm; ?>&text=<?php echo $mensaje_wamsm; ?>');
        /*
