<?php
/* PROCESO DE PREGUNTA DE DEPARTAMENTO PUSH/NAVIGATOR */
if (isset($_COOKIE['token_nav'])) {
    ...
    $rqdt2 = fetch($rqdt1);
    if ($rqdt2['id_departamento'] == '0' && (!isset($_COOKIE['dispushaskdepart']))) {
        ?>
...
<!--                <div class="col-md-2 hidden-xs hidden-sm hidden-xs">
                ...
                <div class="col-md-12 col-xs-12">
                    <div class="pull-right ask-close" onclick='$("#closeask").removeClass("openask");
                            $("#closeask").addClass("closeask");dispushaskdepart();'>X</div>

                    <h3 style="color:red;" class="hidden-xs">QUEREMOS NOTIFICARTE OPORTUNAMENTE</h3>
                    <h5 style="color:red;" class="hidden-lg hidden-sm hidden-md">QUEREMOS NOTIFICARTE OPORTUNAMENTE</h5>
        ...
        <script>
            function dispushaskdepart() {
                var d = new Date();
                d.setTime(d.getTime() + (5 * 24 * 60 * 60 * 1000));
                var expires = "expires=" + d.toUTCString();
                document.cookie = 'dispushaskdepart' + "=" + 'sel' + "; " + expires;
            }
        </script>
