...
Para constancia se establece la firma correspondiente en la ciudad de '.$nombre_ciudad.', a los '.((int)date('d')).' días del más de '.$meses[(int)date('m')].' del '.date('Y').'.';
