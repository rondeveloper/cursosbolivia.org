        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="TituloArea">
                    <h3>FORMULARIO DE DEVOLUCI&Oacute;N</h3>
                </div>
                ...
                <div class="Titulo_texto1">
                    <?php if ($id_emision_factura==0) { ?>
                        <div style="background: #f3fbff;padding: 20px;font-size: 12pt;text-align: justify;border: 1px solid #e0e0e0;">
                            Desde este formulario puede solicitar la devoluci&oacute;n del pago realizado por alg&uacute;n curso, 
                            es necesario justificar de manera detallada el porque de la devoluci&oacute;n. Nuestros adminsitradores revisaran 
                            la solicitud detalladamente y podran aprobar o rechazar dicha solicitud, en caso de ser aprobado se le hara la devoluci&oacute;n.
                            <br>
                            <br>
