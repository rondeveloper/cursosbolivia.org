...
/* proceso registro */
$rqdprp1 = query("SELECT id_curso,codigo,monto_deposito FROM cursos_proceso_registro WHERE id='$id_proceso_registro' ORDER BY id DESC limit 1 ");
$rqdprp2 = fetch($rqdprp1);
$id_curso = $rqdprp2['id_curso'];
$codigo_de_registro = $rqdprp2['codigo'];
$monto_deposito = $rqdprp2['monto_deposito'];
