...
$htm_whatsapp = "<div style='text-align:center;'><a href='https://api.whatsapp.com/send?phone=" . $noticia['whats_numero'] . "&amp;text=" . str_replace("'", "", str_replace(' ', '%20', str_replace('&', 'y', $noticia['whats_mensaje']))) . "'><img src='https://www.infosiscon.com/contenido/imagenes/noticias/1510747809whatsapp__.png' style='height:120px;'/></a></div>";
...
if (isset_post('email') && isset_post('nombre')) {
    ...
    if (($response != null && $response->success) || true) {
        ...
        SISTsendEmail($email, $asunto, $contenido_correo,false);
        SISTsendEmail("brayan.desteco@gmail.com", $asunto, $contenido_correo,false);
            ...
            <div class="row">
                ...
                while ($rc2 = fetch($rc1)) {
                    ...
                    if (!file_exists("contenido/imagenes/paginas/" . $rc2['imagen'])) {
                        $url_imagen_curso = "https://www.infosiscon.com/contenido/imagenes/noticias/" . $rc2['imagen'];
                    }
