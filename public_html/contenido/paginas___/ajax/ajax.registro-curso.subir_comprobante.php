                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <br/>
                                <input class="form-control myinput" type='file' accept="image/*" name='imagen_deposito' required="required" style="padding-top: 30px;padding-bottom: 30px;"/>
                            </td>
                        </tr>
                        <?php
                        if ($id_banco == 'paypal') {
        ...
        <div class="panel-footer">
            <div class="row">
                <div class="col-sm-12 text-center" style="padding: 20px;">
                    <input type="hidden" name="finalizar-registro" value="1"/>
                    <input type="submit" class="btn btn-lg btn-success" value='FINALIZAR REGISTRO' style="border-radius: 7px;" name='subir-comprobante'/>
                </div>
            </div>
        </div>
    </div>
