...
$pdf->Cell(520, 170, "PRE-FACTURA", 0, 2, "C");
...
$pdf->SetXY(470, 65);
$pdf->Cell(0, 0, substr(str_pad($nro_factura, 5, "0", STR_PAD_LEFT),0,3).'***'  , 0, 0, "J");
$pdf->SetXY(470, 80);
$pdf->Cell(0, 0, substr($nro_autorizacion,0,12).'***', 0, 0, "J");
...
$pdf->SetFont('Arial', '', 7.5);
$pdf->SetXY(15, 92);
$pdf->MultiCell(200, 10, utf8_decode("Av camacho Edif. Saenz N° 1377
Piso 3 Of. 301 esq. Loayza, Tel. 69714008
La Paz - Bolivia
", 0, "C"));
...
$data = 'La factura a la que se hace referencia solo tendra validez una vez se apruebe';
...
$pdf->SetFont('Arial', '', 8);
$pdf->SetXY(250, 285);
$pdf->Cell(0, 0, "CODIGO DE CONTROL: ".  substr($codigo_de_control,0,7).'*******', 0, 0, "J");
