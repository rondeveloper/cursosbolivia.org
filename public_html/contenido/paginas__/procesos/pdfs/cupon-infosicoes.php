...
//$pdf->Cell(0, 30, 'Profesionales, Técnicos y Consultores", con una carga horaria de 8 horas.', 0, 0, 'C');
    ...
    $pdf->SetY(190);
    $pdf->SetX(25);
    $pdf->MultiCell(550, 14, utf8_decode('Este cupón fue emitido para '.$nombre_participante.' y constituye la adquisición de un paquete de servicios de la plataforma Infosicoes de monitoreo de licitaciones de Bolivia.'), 0, 'L');
