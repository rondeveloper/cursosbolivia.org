...
$rqef1 = query("SELECT * FROM facturas_emisiones WHERE id='$id_factura' ORDER BY id DESC limit 1 ");
$rqef2 = fetch($rqef1);

$id_dosificacion = $rqef2['id_dosificacion'];
$nro_factura = $rqef2['nro_factura'];
$id_actividad = $rqef2['id_actividad'];
...
$total = $rqef2['total'];
$concepto = str_replace(array('?','🔴'),'',$rqef2['concepto']);
...
/* actividad */
$rqdac1 = query("SELECT actividad FROM facturas_actividades WHERE id='$id_actividad' LIMIT 1 ");
$rqdac2 = fetch($rqdac1);
$actividad_factura = utf8_decode($rqdac2['actividad']);

/* datos emisor */
$rqdem1 = query("SELECT e.* FROM facturas_dosificaciones d INNER JOIN facturas_datos_emisor e ON d.id_datos_emisor=e.id WHERE d.id='$id_dosificacion' LIMIT 1 ");
$rqdem2 = fetch($rqdem1);
$direccion_f1 = utf8_encode($rqdem2['direccion_f1']);
$direccion_f2 = utf8_encode($rqdem2['direccion_f2']);
$direccion_f3 = utf8_encode($rqdem2['direccion_f3']);
$image_logotipo = $rqdem2['logotipo'];
$text_de_propietario = $rqdem2['propietario'];
$info_direccion = "$direccion_f1
$direccion_f2
$direccion_f3
";
...
/* logo */
$pdf->Image($image_logotipo, 40, 30, 150, 50, 'JPG');
...
$pdf->SetXY(400, 112);
$pdf->MultiCell(140, 8, $actividad_factura, 0, "C");

/* data 5a */
$pdf->SetFont('Arial', 'B', 7.5);
$pdf->SetXY(15, 80);
$pdf->MultiCell(200, 10, $text_de_propietario, 0, "C");

/* data 5b */
$pdf->SetFont('Arial', '', 7.5);
$pdf->SetXY(15, 92);
$pdf->MultiCell(200, 10, utf8_decode($info_direccion), 0, "C");
...
$pdf->Cell(0, 0, (utf8_decode($nombre_receptor)), 0, 0, "J");
...
$pdf->SetFont('Arial', '', 9);
$pdf->SetXY(30, 200);
$pdf->MultiCell(390, 12, utf8_decode($concepto), 0, "L");
...
$pdf->SetXY(35, 305);
$pdf->MultiCell(420, 11, utf8_decode('"ESTA FACTURA CONTRIBUYE AL DESARROLLO DEL PAIS, EL USO ILICITO SERA SANCIONADO DE ACUERDO A LA LEY"
Ley No. 453 "El proveedor debe brindar atención sin discriminación, con respeto, calidez y coordialidad a los usuarios consumidores"'), 0, "L");
...
if ($estado !== '1') {
    ...
    $pdf->MultiCell(585, 11, 'FACTURA ANULADA', 0, "C");
}
...
$nombre_archivo = "FACTURA-$nro_factura.pdf";
