...
$rqef1 = query("SELECT p.nombres,p.apellidos,c.titulo,r.monto_deposito FROM cursos_participantes p INNER JOIN cursos_proceso_registro r ON p.id_proceso_registro=r.id INNER JOIN cursos c ON p.id_curso=c.id WHERE p.id IN ($ids_participante) ORDER BY p.id DESC ");
...
$pdf->SetFont('Arial', '', 7.5);
$pdf->SetXY(15, 87);
$pdf->MultiCell(200, 10, "Av camacho Edif. Saenz N° 1377 
