                                            ...
                                            <div class="panel-body">
                                                ...
                                                if ($correo_proceso_registro == '') {
                                                    ...
                                                    <div class="text-center">
                                                        <img src="https://www.infosicoes.com/contenido/imagenes/images/img-pago-deposito.jpg" style="height:115px;margin:0px auto;border-radius:10px;">
                                                    </div>
                                                    ...
                                                    <input type="hidden" name="correo_proceso_registro" value="<?php echo $correo_proceso_registro; ?>"/>
                                                    <div class="text-center">
                                                        <img src="https://www.infosicoes.com/contenido/imagenes/images/img-pago-deposito.jpg" style="height:151px;margin:10px auto;border-radius:10px;">
                                                    </div>
                                                    <?php
                                                }
                                                ?>
