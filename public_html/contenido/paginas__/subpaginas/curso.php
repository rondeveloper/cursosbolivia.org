                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-xs-9 Titulo_texto1"> : &nbsp;<a href='<?php echo $url_registro; ?>'><?php echo $url_registro; ?></a></div>
                                    <div style="height:25px"></div>
                                </div>
                                <?php
                                }
                ...
                <div class="cont-course">
                    ...
                    <div class="panel show text-cont-curso" style="text-align: justify;">
                        ...
                        <div style="font-size: 12pt;margin-top: 10px;margin-bottom: 50px;padding-top: 10px;line-height: 1.8;color: #333;">
                            <?php
                            $rqdd1 = query("SELECT s.*,(d.nombre)departamento FROM sucursales s INNER JOIN departamentos d ON s.id_departamento=d.id WHERE s.estado=1 LIMIT 1 ");
                        ...
                        <h4 style="color: red;">Otros cursos en <?php echo $curso_text_ciudad; ?> <i style="color:gray;font-weight: normal;">(Costos con descuento)</i></h4>
                            <table style="width:100%;">
                                ...
                                while ($rqcmd2 = fetch($rqcmd1)) {
                                    ...
                                    $rqenc1 = query("SELECT e.enlace FROM rel_cursoenlace r INNER JOIN enlaces_cursos e ON e.id=r.id_enlace WHERE r.id_curso='".$rqcmd2['id']."' AND r.estado=1 ");
                                    if(num_rows($rqenc1)>0){
                                        $rqenc2 = fetch($rqenc1);
