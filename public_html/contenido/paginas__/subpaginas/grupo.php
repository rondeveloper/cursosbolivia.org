...
$htm_whatsapp = "<div style='text-align:center;'><a href='https://api.whatsapp.com/send?phone=" . $grupo['whats_numero'] . "&amp;text=" . str_replace("'", "", str_replace(' ', '%20', str_replace('&', 'y', $grupo['whats_mensaje']))) . "'><img src='https://www.infosicoes.com/contenido/imagenes/paginas/1510747809whatsapp__.png' style='height:120px;'/></a></div>";
