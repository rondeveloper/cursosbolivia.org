                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <form action="registro-curso-p5c.html" method="post" onsubmit="return verificar_datos();">
                                            ...
                                            <?php if (isset_post('solicitar_envio_cert_fisico')) { ?>
                                                <input type="hidden" name="solicitar_envio_cert_fisico" value="<?php echo post('solicitar_envio_cert_fisico'); ?>"/>
                                                <input type="hidden" name="direccion_envio_cert_fisico" value="<?php echo post('direccion_envio_cert_fisico'); ?>"/>
                                            <?php } ?>
