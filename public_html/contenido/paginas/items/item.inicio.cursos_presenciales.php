        ...
        <div class="col-xs-12 col-sm-6 col-md-6" align="left">
            <div class="blog-post-short">
                <div class="img-holder">
                    <div class="bg-img-holder bx-img-curso-f1" style="height: 400px;">
                        <a href="<?php echo $url_pagina_curso; ?>">
                            <img src="<?php echo $url_imagen_curso; ?>" alt="<?php echo $titulo_de_curso; ?>" title="<?php echo $titulo_de_curso; ?>" class="img-responsive grafico img-curso-f1" style="max-height: 100%;" />
                        </a>
                    </div>
                </div>
