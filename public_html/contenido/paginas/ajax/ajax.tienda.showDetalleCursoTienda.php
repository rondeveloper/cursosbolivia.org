...
/* id curso */
$rqdc1 = query("SELECT * FROM cursos WHERE id='$id_curso' AND estado IN (0,1,2) ORDER BY FIELD(estado,1,2,0),id DESC limit 1 ");
if (num_rows($rqdc1) == 0) {
...
<div class="wrapsemibox course-self" style="margin-top: -10px;">
