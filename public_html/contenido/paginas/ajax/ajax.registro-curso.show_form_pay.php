...
$id_banco = post('data');
$id_curso = post('cod');
$celular_participante = post('celular_participante');
$__valor_dolar = 6.97;
...
/* registro */
$rqdr1 = query("SELECT c.costo,c.sw_fecha2,c.fecha2,c.costo2,c.sw_fecha3,c.fecha3,c.costo3 FROM cursos c WHERE c.id='$id_curso' ORDER BY c.id DESC limit 1");
$rqdr2 = fetch($rqdr1);
...
$url_proc_registro = $dominio . 'registro-curso/' . $titulo_identificador_curso. '.html';
?>
<style>
    .img-det-fpay{
...
<div id="AJAXCONTENT-subir-comprobante">
<?php
if ($id_banco == 'tigomoney') {
    ...
    <div>
        <div class="row">
            ...
            <div class="col-md-8 col-xs-12">
                ...
                <br>
                <b onclick="subir_comprobante();" class="link-set-fpay">SUBIR COMPROBANTE</b>
                <br>
                <br>
                <hr>
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-xs-12">
                ...
                if ($monto_a_pagar == 0) {
                    ...
                    <br>
                    <b onclick="subir_comprobante();" class="link-set-fpay" style="padding: 5px 15px;font-size: 14pt;text-decoration: none;">SUBIR COMPROBANTE</b>
                    <br>
                    <br>
                    <?php
                }
    ...
    <div id="info-pago" style="display:none;">
        ...
        <table class="table table-bordered tabla-det-fpay">
            ...
            <?php
            $rqcp1 = query("SELECT * FROM cuentas_de_banco WHERE id_banco='$id_banco' AND estado=1 ");
...
<script>
    function subir_comprobante() {
        $("#AJAXCONTENT-subir-comprobante").html('Cargando...');
        $.ajax({
            url: 'contenido/paginas/ajax/ajax.registro-curso.subir_comprobante.php',
            data: {cod: '<?php echo $id_curso; ?>', data: '<?php echo $id_banco; ?>'},
            type: 'POST',
            dataType: 'html',
            success: function (data) {
                $('#AJAXCONTENT-subir-comprobante').html(data);
            }
        });
    }
</script>
