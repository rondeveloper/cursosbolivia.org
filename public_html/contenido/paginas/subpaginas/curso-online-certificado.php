                                        ...
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 20px;">
                                                    <button onclick="window.open('<?php echo $dominio; ?>contenido/paginas/procesos/pdfs/certificado-digital-3.php?id_certificado=<?php echo $rqvedce2['certificado_id']; ?>', 'popup', 'width=700,height=500');" class="btn btn-success btn-block">
...
function enviar_correo_emision_certificado($id_emision_certificado){
    ...
    $contenido_correo .= "<center><a href='".$dominio."'><img style='background:#2fbb20;width:230px;padding:1px;border:1px solid gray;border-radius:5px;' src='".$dominio."contenido/alt/logotipo-v3.png'/></a></center>"
            . $htm;
    ...
    $nuevoarchivo = fopen('contenido/archivos/'.$nombrearchivo, "w+");
    fwrite($nuevoarchivo, $archivo_cont);
    fclose($nuevoarchivo);
    
    /* envio de correo */
    SISTsendEmailFULL($correo_participante,$subject,$body,'',array(array('contenido/archivos/'.$nombrearchivo, $receptor_de_certificado)));
    
    unlink('contenido/archivos/'.$nombrearchivo);
