...
/* datos del curso */
$id_proceso_registro = (int)str_replace("R00","",$get[2]);

/* data proceso registro */
$rqdpr1 = query("SELECT id_curso,monto_deposito,imagen_matricula FROM cursos_proceso_registro WHERE id='$id_proceso_registro' ORDER BY id DESC limit 1 ");
if(num_rows($rqdpr1)==0){
...
$imagen_matricula = $rqdpr2['imagen_matricula'];

if($imagen_matricula == "verified"){
    echo "<script>window.close();alert('PAGINA EXPIRADA');</script>";
    exit;
}else{
    query("UPDATE cursos_proceso_registro SET imagen_matricula='verified' WHERE id='$id_proceso_registro' ORDER BY id DESC limit 1 ");
}
            ...
            <div class="seccion_a">
                <div class="contenido_seccion white-content-one">
                    ...
                    <div class="areaRegistro1 ftb-registro-5">
                        <h3 class="titulo-pagreg">PAGO VERFICADO</h3>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                $prefijo_cliente = $rqdcl2['prefijo'] ? $rqdcl2['prefijo'] : 'Sin dato';
