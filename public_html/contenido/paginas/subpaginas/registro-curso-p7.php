...
<div style='border:1px dashed #DDD;padding:0px 20px;'>
                                            <h1 style='padding-bottom:5px;margin-bottom:0px;text-align:center;color:#003e54;'>
                                                PROCESO DE INSCRIPCI&Oacute;N PARA CURSO
                                            </h1>
                                            <div style='width:20%;margin:auto;'>
                                                <img src='".$dominio."contenido/alt/logotipo-v3.png' style='background:#31b312;border-radius:5px;width:100%;padding:5px 10px;border:1px solid gray;border-radius:10px;' alt='Cursos InfoSICOES'>
                                            </div>
                                            <div style='line-height:2;'>
                                                ...
                                                <p style='text-align: left;'>
                                                    <span style='font-size: 11pt; color: #000000;'>
                                                        Para poder hacer el ingreso el d&iacute;a del curso es necesario llevar la ficha de inscripci&oacute;n previamente impresa junto con el deposito original del pago realizado.
                                                        <br/>
                                                        La ficha de inscripci&oacute;n puedes imprimirla y descargarla desde el siguiente enlace: 
                                                    </span>
                                                </p>
                                                <p style='text-align:center;'>
                                                    <br/>
                                                    <a href='" . $dominio . encrypt('registro-participantes-curso/' . $id_proceso_registro) . ".impresion'>FICHA DE INSCRIPCI&Oacute;N</a>
                                                    <br/>
                                                    <br/>
                                                </p>
                                                <p style='text-align: left;'>
    ...
    $contenido_correo .= "                </div>
        ...
        <br/>
        <br/>
        Esperamos que nuestros servicios te sean de utilidad.<br/><br/>Gracias por tu atenci&oacute;n.<br/></p>
        <hr/>
        <br/>
        <div style='margin:auto;width:80%;font-size:9.5pt;color:#333;line-height:2;'>
            <i>".$___nombre_del_sitio."</i>
            <br/>
            info@nemabol.com
            <br/>
            Av camacho Edif. Saenz N° 1377 Piso 3 Of. 301 esq. Loayza
            <br/>
            69713008 - L&iacute;nea ".$___nombre_del_sitio."Cursos BO
        </div>
    </div>
</div>";

    $asunto = utf8_encode("Proceso de inscripci�n $codigo_de_registro - ") . $titulo_curso;
    //$correo_proceso_registro = "brayan.desteco@gmail.com";
    //*envio_email($correo_proceso_registro, $asunto, $contenido_correo);
}
...
<div style='border:1px dashed #DDD;padding:0px 20px;'>
                                            ...
                                            <div style='line-height:2;'>
                                                ...
                                                <p style='text-align: left;'>
                                                    <span style='font-size: 11pt; color: #000000;'>
                                                        Para poder hacer el ingreso el d�a del curso es necesario llevar la ficha de inscripci&oacute;n previamente impresa junto con el deposito original del pago realizado.
                                                        <br/>
                                                        La ficha de inscripci&oacute;n se te enviara a este correo cuando reportes el pago en el siguiente enlace: 
                                                    </span>
                                                </p>
                                                <p style='text-align:center;'>
                                                    <br/>
                                                    <a href='".$dominio."registro-curso-reportar-pago/$codigo_de_registro/$hashcod_registro.html'><b>REPORTAR DEPOSITO BANCARIO</b></a>
                                                    <br/>
                                                    <br/>
                                                </p>
                                                <p style='text-align: left;'>
                                                    <span style='font-size: 11pt; color: #000000;'>
                                                        Una vez reportado el pago se te enviara la ficha de inscripci&oacute;n con la cual podras asistir al curso '$titulo_curso' a llevarse a cabo 
                                                        en fecha $fecha_curso en la ciudad de $ciudad_curso.
                                                        <br/>
                                                </p>
                                                
                                                <p>
                                                   Puedes visualizar el estado de tu inscripci&oacute;n en el siguiente enlace: 
                                                   <br/>
                                                   <a href='" . $dominio . encrypt('registro-participantes-curso/' . $id_proceso_registro) . ".impresion'><b>ESTADO DE INSCRIPCION</b></a>
                                                </p>";

    if ($curso['fecha2'] !== '0000-00-00' && $curso['costo2'] > 0) {
        $fecha2 = date("d / m / Y", strtotime($curso['fecha2']));
        $contenido_correo .= "<br/><p><b>Costo del curso: " . $curso['costo'] . " Bs.</b>
                              <br/>
                              Descuentos por pago anticipado:
                              <br/>
                              " . $curso['costo2'] . " Bs. hasta $fecha2";
        if ($curso['fecha3'] !== '0000-00-00' && $curso['costo3'] > 0) {
            $fecha3 = date("d / m / Y", strtotime($curso['fecha3']));
            $contenido_correo .= "<br/>" . $curso['costo3'] . " Bs. hasta $fecha3";
        }
        $contenido_correo .= "</p>";
    }
    ...
    $contenido_correo .= "                </div>
        ...
        <br/>
        <br/>
        Esperamos que nuestros servicios te sean de utilidad.<br/><br/>Gracias por tu atenci�n.<br/></p>
        <hr/>
        <br/>
        <div style='margin:auto;width:80%;font-size:9.5pt;color:#333;line-height:2;'>
            <i>".$___nombre_del_sitio."</i>
