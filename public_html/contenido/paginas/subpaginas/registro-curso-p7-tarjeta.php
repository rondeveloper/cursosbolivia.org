...
<div style='border:1px dashed #DDD;padding:0px 20px;'>
                                            <h1 style='padding-bottom:5px;margin-bottom:0px;text-align:center;color:#003e54;'>
                                                INSCRIPCI&Oacute;N PARA CURSO
                                            </h1>
                                            <div style='width:20%;margin:auto;'>
                                                <img src='".$dominio."contenido/alt/logotipo-v3.png' style='background:#31b312;border-radius:5px;width:100%;padding:5px 10px;border:1px solid gray;border-radius:10px;' alt='Cursos'>
                                            </div>
                                            <div style='line-height:2;'>
                                                ...
                                                <p style='text-align: left;'>
                                                    <span style='font-size: 11pt; color: #000000;'>
                                                        Para poder hacer el ingreso el d&iacute;a del curso es necesario llevar la ficha de inscripci&oacute;n previamente impresa junto con el comprobante del pago realizado.
                                                        <br/>
                                                ...
                                                <p style='text-align:center;'>
                                                    <br/>
                                                    <a href='" . $dominio . encrypt('registro-participantes-curso/' . $id_proceso_registro) . ".impresion'><b>FICHA DE INSCRIPCI&Oacute;N</b></a>
                                                    <br/>
                                                </p>
                                                <p style='text-align: left;'>
                                                    <span style='font-size: 11pt; color: #000000;'>
                                                        Puedes descargar el comprobante de pago o completar el proceso de pago si a&uacute;n no lo has hecho en el siguiente enlace: 
                                                    </span>
                                                </p>
                                                <p style='text-align:center;'>
                                                    <br/>
                                                    <a href='" . $url_de_pago . "'><b>COMPROBANTE DE PAGO</b></a>
                                                    <br/>
                                                    <br/>
                                                </p>
                                                <p style='text-align: left;'>
        ...
        <div style='margin:auto;width:80%;font-size:9.5pt;color:#333;line-height:2;'>
            ...
            <br/>
            (591-2) 2118783 L&iacute;nea ".$___nombre_del_sitio."
        </div>
    </div>
</div>";
