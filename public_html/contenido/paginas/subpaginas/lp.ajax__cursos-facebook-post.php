        ...
        <table class="table table-bordered table-striped">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <label><input type="checkbox" name="" style="width: 50px;height:50px;"> Detalle</label>
                        <br>
                        <label><input type="checkbox" name="" style="width: 50px;height:50px;"> Formas de pago Bancos/ TigoMoney</label>
                        <br>
                        <label><input type="checkbox" name="" style="width: 50px;height:50px;"> Reportar Pago</label>
                        <br>
                        <label><input type="checkbox" name="" style="width: 50px;height:50px;"> WhatsApp</label>
                        <br>
                        <label><input type="checkbox" name="" style="width: 50px;height:50px;"> Link Detalle curso</label>
                    </td>
                    <td><?php echo $data; ?></td>
                </tr>
            <?php
