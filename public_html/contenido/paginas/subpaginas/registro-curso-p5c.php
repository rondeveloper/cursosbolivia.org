...
se ha registrado sus datos como participante del curso.
    ...
    if (isset($_SESSION[$key_participante_registrado])) {
        ...
        $rqdpr1 = query("SELECT id_curso,codigo,sw_pago_enviado,monto_deposito FROM cursos_proceso_registro WHERE id='$id_proceso_registro' ORDER BY id DESC limit 1 ");
        $rqdpr2 = fetch($rqdpr1);
        $id_curso = $rqdpr2['id_curso'];
        $codigo_de_registro = $rqdpr2['codigo'];
        $sw_pago_enviado = $rqdpr2['sw_pago_enviado'];
...
/* sw registro estudiante */
$sw_precio_estudiantes = false;
if($curso['costo_e']!='0' || $curso['costo_e2']!='0'){
    $sw_precio_estudiantes = true;
}
                    ...
                    <div class="areaRegistro1 ftb-registro-5">
                            ...
                            <div class="col-md-6">
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td style='padding:5px;'><?php echo isset($monto_deposito) ? $monto_deposito : $curso['costo']; ?></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        ...
                        if ((int) $curso['costo'] > 0) {
                            ...
                            if ($sw_pago_enviado == '1' && (!$sw_update_reportepago)) {
                                ...
                                /* cuenta bancaria */
                                $rqdcb1 = query("SELECT c.*,(b.nombre)nombre_banco FROM rel_cursocuentabancaria r INNER JOIN cuentas_de_banco c ON r.id_cuenta=c.id INNER JOIN bancos b ON c.id_banco=b.id WHERE b.estado=1 AND c.estado=1 AND r.id_curso='$id_curso' AND r.sw_cprin=1 AND r.estado=1 ORDER BY c.id ASC ");
                                $rqdcb2 = fetch($rqdcb1);
                                ...
                                ?>
                                    <div class="alert alert-info">
                                        Para asegurar su cupo en el curso puede realizar el pago del curso previamente y subir el comprobante de pago, tambien puede realizar el pago el d&iacute;a del curso asistiendo 15 minutos antes.
                                    </div>
                                <?php
                                } else {
                                ?>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <table class="table table-bordered">
                                                                <tr>
                                                                    <td colspan="2">
                                                                        ...
                                                                        <select class="form-control myinput" name='id_modo_pago' onchange="modPago(this.value);">
                                                                            ...
                                                                            ?>
                                                                            <option value="12">PAGO QR</option>
                                                                        </select>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr id="TR-idtransaccion" style="display: none;">
                                                                    <td colspan="2">
                                                                ...
                                                                <?php if($sw_precio_estudiantes): ?>
                                                                    <tr>
                                                                        <td colspan="2">
                                                                            <br>
                                                                            <div class="alert alert-warning">Para acceder al precio de estudiante es necesario subir la matricula</div>
                                                                            <b>Matricula de estudiante: (OPCIONAL)</b>
                                                                            <br/>
                                                                            <input class="form-control myinput" type='file' accept="image/*" name='imagen_matricula' placeholder="Matricula... (OPCIONAL)"/>
                                                                        </td>
                                                                    </tr>
                                                                <?php endif; ?>
                                                            </table>
