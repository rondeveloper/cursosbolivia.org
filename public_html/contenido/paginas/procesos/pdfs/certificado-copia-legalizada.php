...
if($fecha_qr==$fecha2_qr){
    ...
    $txt_fecha = 'del '.date("d/m/Y",strtotime($fecha_qr)).' al '.date("d/m/Y",strtotime($fecha2_qr));
}
...
$data = 'COPIA LEGALIZADA | '.$certificado_id.' | '.$texto_qr.' | '.$receptor_de_certificado.' | '.$fecha_curso;
...
//linea
$pdf->Line(105,80,505,80);

/* titulo */
$pdf->SetY(100);
$pdf->SetX(100);
$pdf->Cell(0, 0, "CURSOS.BO", 0, 0, 'L');
$pdf->SetFont('Arial', 'B', 25);

//linea
$pdf->Line(105,117,350,117);

//txt: copia legalizada
$pdf->SetY(140);
$pdf->SetX(100);
$pdf->Cell(0, 0, "COPIA LEGALIZADA", 0, 0, 'L');
...
$pdf->Cell(0, 0, "Participante: ".$receptor_de_certificado, 0, 0, 'L');

//id certificado
$pdf->SetY(190);
$pdf->SetX(100);
$pdf->SetFont('Arial', '', 12);
$pdf->Cell(0, 0, "ID de certificado: " . $certificado_id, 0, 0, 'L');

//titulo curso
$pdf->SetY(210);
$pdf->SetX(100);
$pdf->SetFont('Arial', '', 12);
$pdf->Cell(0, 0, "Curso: " . $texto_qr, 0, 0, 'L');

//fecha curso
$pdf->SetY(230);
$pdf->SetX(100);
$pdf->SetFont('Arial', '', 12);
$pdf->Cell(0, 0, "Fecha: " . $txt_fecha, 0, 0, 'L');

//codigo QR
$pdf->Image($file_qr_certificado, 390, 85, 120, 120);

//linea
$pdf->Line(105,245,505,245);

//fecha curso
$pdf->SetY(255);
$pdf->SetX(100);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(0, 0, utf8_decode("Consta la legalización de la copia al reverso de esta hoja con los datos ingresados en el codigo QR conforme a los"), 0, 0, 'L');
$pdf->SetY(265);
$pdf->SetX(100);
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(0, 0, utf8_decode("registros originales de Cursos.BO, emisión de copia legalizada en fecha: ").date("d/m/Y"), 0, 0, 'L');
