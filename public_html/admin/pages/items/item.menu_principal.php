...
<ul class="sidebar-nav">
    ...
    <?php if (acceso_cod('adm-organizadores')) { ?>
        <li>
            <a tec="-" class="sidebar-nav-menu"><i class="fa fa-angle-left sidebar-nav-indicator"></i><i class="fa fa-university sidebar-nav-icon"></i>Notificadores</a>
            <ul>
                <li>
                    <a href="notificadores-correo-listar.adm">Listar correos</a>
                </li>
            </ul>
        </li>
    <?php } ?>
    ...
    <?php if (acceso_cod('adm-cursos')) { ?>
        <li>
            ...
            <ul>
                <li>
                    <a href="certificados-autorizaciones.adm">Autorizaciones</a>
                </li>
                <li>
    ...
    <?php if (acceso_cod('adm-facturas') && $sw_facturacion_modulos) { ?>
        <li>
            ...
            <ul>
                <li>
                    <a href="facturacion-dosificaciones.adm">Dosificaciones</a>
                </li>
                <li>
