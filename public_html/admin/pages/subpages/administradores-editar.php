...
if (isset_post('update-nivel-administrador')) {
        $nivel_administrador = post('nivel_administrador');
        query("UPDATE administradores SET "
            . "nivel='$nivel_administrador' "
            . " WHERE id='$id_administrador' AND estado='1' LIMIT 1 ");
        movimiento('Edicion de nivel de administrador - [' . $id_administrador . ']', 'edicion-administrador', 'administrador', $id_administrador);
        $mensaje = '<div class="alert alert-success">
  <strong>Exito!</strong> registro modificado exitosamente.
</div>';
  } 
...
<div class="panel panel-info">
    ...
    <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="n_a">Nivel de Administrador</label>
                                    <select class="form-control" name="nivel_administrador" id="n_a">
                                        <option value="">Seleccione nivel de administrador</option>
                                        <option value="1">Nivel UNO</option>
                                        <option value="2">Nivel DOS</option>
                                        <option value="3">Nivel TRES</option>
                                        <option value="4">Nivel CUATRO</option>
                                        <option value="9">SIN PRIVILEGIOS</option>
                                    </select>
                                </div>
                            </div>
                        </div>
        ...
        <div class="panel-footer">
            <input type="submit" name="update-nivel-administrador" class="btn btn-success btn-sm btn-animate-demo btn-block" value="ACTUALIZAR NIVEL DE ADMINISTRADOR" />
        </div>
    </form>
</div>
