...
if (isset_post('editar-leccion')) {
    ...
    if (isset_archivo('archivo_adicional')) {
        $archivo_adicional = 'archivo_adicional' . $id_onlinecourse  . '-' .rand(99,9999) . '-' . archivoName('archivo_adicional');
        move_uploaded_file(archivo('archivo_adicional'), $___path_raiz . "contenido/archivos/cursos/lecciones/$archivo_adicional");
        $dato_archivo_adicional = query("SELECT archivo_adicional FROM cursos_onlinecourse_lecciones WHERE id='$id_leccion' ORDER BY id DESC limit 1");
        $dato_archivo_adicional2 = fetch($dato_archivo_adicional);
        unlink( $___path_raiz . "contenido/archivos/cursos/lecciones/" . $dato_archivo_adicional2['archivo_adicional'], NULL);
        query("UPDATE cursos_onlinecourse_lecciones SET
        archivo_adicional='$archivo_adicional'
...
if (isset_post('crear-leccion-onlinecourse')) {
    ...
    (id_onlinecourse,nro_leccion,urltag,titulo,sw_vimeo,minutos,video,localvideofile,archivo_adicional,estado) 
    VALUES 
    ('$id_onlinecourse','$nro_leccion','$urltag','$titulo','$sw_vimeo','$minutos','$video','$localvideofile','$archivo_adicional','1')");
                ...
                <table class="table table-striped table-bordered">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><div style="font-weight: bold;color: #1c79b7;font-size: 10pt;">
                            <?= $leccion['titulo'] ?></div><b>Archivo Adicional:</b>
                            <?php if($leccion['archivo_adicional']!=''){ ?>
                                <a href="<?= $dominio ?>contenido/archivos/cursos/lecciones/<?= $leccion['archivo_adicional'] ?>" target="_blank">Ver Archivo</a><?php } else {
                                    echo 'Sin Archivo';
                                } 
                            ?>
                            </td>
            ...
            <div class="modal-body">
                <form action="" method="post" enctype="multipart/form-data">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr id="tr-vm" style="display: table-row;">
                            <td><b>Archivo Adicional:</b><br>(TXT Zoom)</td>
                            <td><input type="file" name="archivo_adicional" class="form-control"/></td>
                        </tr>
                        <tr>
                            <td colspan="2">
