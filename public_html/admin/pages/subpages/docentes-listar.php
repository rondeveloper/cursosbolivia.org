...
if (isset_post('agregar-docente')) {
    ...
    $sw_acceso_cuenta_cvir = post('sw_acceso_cuenta_cvir');
...
if (isset_post('editar-docente')) {
    ...
    query("UPDATE cursos_docentes SET "
            ...
            . "sw_acceso_cuenta_cvir='$sw_acceso_cuenta_cvir',"
            . "pago_hora='$pago_hora',"
...
/* editar-docente */
if (isset_post('editar-cvir-docente')) {
    $id_docente = post('id_docente');
    $nick = post('nick');
    ...
    query("UPDATE cursos_docentes SET "
            ...
            . "celular='$celular' "
            . " WHERE id='$id_docente' LIMIT 1 ");
    movimiento('Edicion de docente cvir', 'edicion-docente', 'docente', $id_docente);
    $mensaje .= '<div class="alert alert-success">
  <strong>Exito!</strong> registro editado correctamente.
</div>';
}
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            while ($producto = fetch($resultado1)) {
                                ...
                                $txt_estado = '<span class="label label-default">DESACTIVADO</span>';
                                if ($producto['estado'] == '1') {
                                    $txt_estado = '<span class="label label-success">ACTIVADO</span>';
                                }
                                
                                $htm_pcvir = '<span class="label label-default">No habilitado</span>';
                                if ($producto['sw_acceso_cuenta_cvir'] == '1') {
                                    $htm_pcvir = '<span class="label label-info">Habilitado</span>';
                                }
                                ?>
                                <tr>
                                    <td><?php echo $cnt--; ?></td>
                                    ...
                                    <td><?php echo substr(strip_tags($producto['curriculum']), 0, 70); ?>...</td>
                                    <td>
                                        <?php
                                    ...
                                    <td>
                                        ...
                                        <?php if ($producto['sw_acceso_cuenta_cvir'] == '1') { ?>
                                            <a data-toggle="modal" data-target="#MODAL-editar-cvir-<?php echo $producto['id']; ?>">
                                                <button type="button" class="btn btn-warning active"><i class="fa fa-user"></i></button>
                                            </a>
                                        <?php } ?>
                                                        ...
                                                        <div class="panel panel-default">
                                                            <form action="" method="post">
                                                                <div class="panel-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group">
                                                                            <label class="col-lg-3 col-md-3 control-label text-primary">CUENTA/PANEL CVIR</label>
                                                                            <div class="col-lg-9 col-md-9">
                                                                                <select class="form-control form-cascade-control" name="sw_acceso_cuenta_cvir">
                                                                                    <?php 
                                                                                    if($producto['sw_acceso_cuenta_cvir']=='1'){
                                                                                        ?>
                                        ...
                                        <!-- Modal -->
                                        <div id="MODAL-editar-cvir-<?php echo $producto['id']; ?>" class="modal modal-info fade" role="dialog">
                                            <div class="modal-dialog">
                                                <!-- Modal content-->
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                        <h4 class="modal-title"><i class="fa fa-edit"></i> EDICI&Oacute;N PANEL/CUENTA CVIR</h4>
                                                    </div>
                                                    <div class="modal-body">
                                                        <div class="panel panel-default">
                                                            <form action="" method="post">
                                                                <div class="panel-body">
                                                                    <div class="row">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-9 col-md-9">
                                                                                <input type="text" class="form-control form-cascade-control" name="nick" value="<?php echo $producto['nick']; ?>" placeholder="nick..." autocomplete="off"/>
                                                                                <br/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-9 col-md-9">
                                                                                <input type="text" class="form-control form-cascade-control" name="password" value="<?php echo $producto['password']; ?>" required placeholder="..." autocomplete="off"/>
                                                                                <br/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-9 col-md-9">
                                                                                <input type="text" class="form-control form-cascade-control" name="email" value="<?php echo $producto['email']; ?>" placeholder="email..." autocomplete="off"/>
                                                                                <br/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="row">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-lg-9 col-md-9">
                                                                                <input type="text" class="form-control form-cascade-control" name="celular" value="<?php echo $producto['celular']; ?>" placeholder="celular..." autocomplete="off"/>
                                                                                <br/>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="panel-footer">
                                                                    <input type="hidden" name="id_docente" value="<?php echo $producto['id']; ?>"/>
                                                                    <input type="submit" name="editar-cvir-docente" class="btn btn-success btn-sm btn-animate-demo" value="ACTUALIZAR DATOS"/>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
