...
if (isset_post('agregar-certificado-adicional')) {
    ...
    if(strtotime($fecha_qr)>strtotime($fecha2_qr)){
        ...
        query("INSERT INTO cursos_certificados
            (id_curso, id_tipo_cert, codigo, modelo, cont_titulo, cont_uno, cont_dos, cont_tres,texto_qr,fecha_qr,fecha2_qr,sw_solo_nombre,id_fondo_digital, estado) 
                VALUES 
            ('$id_curso','$id_tipo_cert','$codigo_certificado','1','$cont_titulo','$cont_uno','$cont_dos','$cont_tres','$texto_qr','$fecha_qr','$fecha2_qr','$sw_solo_nombre','$id_fondo_digital','1')");
                                            ...
                                            <td colspan="2">
                                                <div class="panel-group">
                                                    <div class="panel panel-info">
                                                        <div class="panel-heading" data-toggle="collapse" href="#collapse_TC" style="cursor:pointer;" onclick="cont_dinamico_tags();">
...
<!-- cont_dinamico_tags -->
<script>
    function cont_dinamico_tags() {
        $("#TITLE-modgeneral").html('TAGS - CONTENIDO DINAMICO');
        $("#AJAXCONTENT-modgeneral").html('Cargando...');
        $("#MODAL-modgeneral").modal('show');
        $.ajax({
            url: 'pages/ajax/ajax.cursos-editar.cont_dinamico_tags.php',
            data: {id_curso: '<?php echo $id_curso; ?>'},
            type: 'POST',
            dataType: 'html',
            success: function (data) {
