...
if ($rqc2['imagen'] !== '') {
    $url_imagen_del_capacitacion = "https://www.infosiscon.com/paginas/" . $rqc2['imagen'] . ".size=4.img";
} else {
    $url_imagen_del_capacitacion = "https://www.infosiscon.com/images/banner-capacitaciones.png.size=4.img";
}
