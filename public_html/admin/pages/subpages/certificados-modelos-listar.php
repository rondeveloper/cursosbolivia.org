                        ...
                        while ($producto = fetch($resultado1)) {
                            ...
                            <tr>
                                ...
                                <td class="visible-lg" style="width:120px;">
                                    ...
                                    <br/>
                                    <a onclick="window.open('http://www.infosicoes.com/contenido/paginas/procesos/pdfs/certificado-2-modelo.php?id_modelo=<?php echo $producto['id']; ?>', 'popup', 'width=700,height=500');" style="cursor:pointer;"><i class='fa fa-file-pdf-o'></i> Visualizar</a>
                                </td>
                            </tr>
                            <?php
                        }
