...
$rqmc1 = query("SELECT * FROM cursos_examenes_preguntas WHERE id='$id_pregunta' LIMIT 1 ");
            ...
            <td style="padding:20px;">
                ...
                <div>
                    <table style="width:100%;" class="table table-striped">
                        <?php
                        $cnt_aux = 1;
                        $rqdr1 = query("SELECT respuesta,sw_correcto FROM cursos_examenes_respuestas WHERE id_pregunta='$id_pregunta' ORDER BY id ASC ");
