...
<p>&nbsp;</p>
    ...
    text-decoration: none;">
                                    ...
                                    ';
/* cont correo */
$contenido_correo = "<h2 style='text-align:center;background:#31b312;color:#FFF;border-radius:5px;padding:5px;'>Bienvenida y curso gratuito - CURSOS BO</h2>";
...
/* datos de correo */
$asunto = "Bienvenida y curso gratuito - CURSOS BO";
