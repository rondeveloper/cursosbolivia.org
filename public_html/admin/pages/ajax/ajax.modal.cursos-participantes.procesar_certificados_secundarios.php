...
if (isset_administrador()) {
    ...
    if (num_rows($rqcea1) > 0) {
        ...
        <table class="table table-striped">
            ...
            while ($rqcea2 = fetch($rqcea1)) {
                ...
                <tr>
                    ...
                    <td><button onclick="window.open('http://www.infosicoes.com/contenido/paginas/procesos/pdfs/certificado-4.php?id_certificado=<?php echo $certificado_id; ?>', 'popup', 'width=700,height=500');" class="btn btn-default btn-xs">IMPRIMIR CERTIFICADO</button></td>
                </tr>
                <?php
            }
            ?>
        ...
        <button class="btn btn-success" onclick="window.open('http://www.infosicoes.com/contenido/paginas/procesos/pdfs/certificado-4-masivo.php?id_participantes=<?php echo $id_participante; ?>&id_modelo_certificado=<?php echo $ids_modelos_certificados_env; ?>', 'popup', 'width=700,height=500');">IMPRIMIR EMITIDOS</button>
