...
if (isset_administrador()) {
    ...
    echo $dominio."contenido/paginas/procesos/pdfs/certificado-digital-$formato_certificado.php?id_certificado=$certificado_id&id_administrador=$id_administrador&hash=".md5($id_administrador.'hash');
} else {
    echo "Denegado!";
}
