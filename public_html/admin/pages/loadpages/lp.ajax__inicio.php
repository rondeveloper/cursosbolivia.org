...
<div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-8" style="margin-top: 12px;">
                <table class="table table-bordered" style="background: #f9f9f9;">
                    <tr>
                        <td>
                            <div stylesheet="cursos-bo-curso_search">CURSO:</div>
                            <div class="cursos-radio-search">
                                    <label>
    ...
    <?php
    /* LISTADO RAPIDO DE CURSOS ACTIVOS */
    require_once __DIR__.'/inc/inc.lp.inicio.cursos-activos.php';
    ?>
