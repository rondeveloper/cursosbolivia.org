...
if (isset_post('formulario')) {
    ...
    $id_noticia = insert_id();

    logcursos('Creacion de noticia [' . $titulo . ']', 'noticia-creacion', 'noticia', $id_noticia);

    $mensaje .= '<div class="alert alert-success">
      <strong>Exito!</strong> la noticia fue creada correctamente.
    </div>
    <script>alert("Creacion de registro exitoso.");location.href="noticias-editar/'.$id_noticia.'.adm";</script>';
}
...
<div class="row">
    <div class="col-mod-12">
        <ul class="breadcrumb">
            ...
            <li><a <?php echo loadpage('noticias-listar'); ?>>Noticias</a></li>
            <li class="active">Creaci&oacute;n</li>
        </ul>
        <div class="form-group hiddn-minibar pull-right">

        </div>
        <h3 class="page-header"> CREACI&Oacute;N DE NOTICIA </h3>
        <blockquote class="page-information hidden">
            <p>
                Creaci&oacute;n de noticia
            </p>
        </blockquote>
    </div>
</div>
        ...
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">DATOS DE LA NOTICIA</div>
                    <form enctype="multipart/form-data" action="noticias-crear.adm" method="post">
                        <div class="panel-body">
                            ...
                            <div class="tab-content">
                                <div id="home" class="tab-pane fade in active">
                                    <table style="width:100%;" class="table table-striped">
                                        <tr>
                                            <td>
                                                <span class="input-group-addon"><i class="fa fa-calendar"></i> &nbsp; T&iacute;tulo de la noticia: </span>
                                            </td>
                                            <td>
                                                <input type="text" name="titulo" value="" class="form-control" id="date" required="">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
...
<!--                                                    &nbsp;&nbsp;&nbsp;&nbsp;
                            ...
                            <p class="text-center">[ Posterior a la creaci&oacute;n se le redireccionar&aacute; al modulo de edici&oacute;n de noticia ]</p>

                        </div>
                        <div class="panel-footer">
                            <div style="text-align: center;padding:20px;">
                                <input type="submit" value="CREAR NOTICIA" name="formulario" class="btn btn-success btn-block active"/>
                            </div>
                        </div>
                    </form>
                </div>
