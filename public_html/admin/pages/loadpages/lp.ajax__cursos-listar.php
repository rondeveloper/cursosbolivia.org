...
c.laststch_fecha,c.laststch_id_administrador, c.short_link, c.sw_view_home, c.sw_view_cat,  
            ...
            <div class="col-md-8" style="margin-top: 12px;">
                <table class="table table-bordered hidden-xs" style="background: #f9f9f9;">
                    <tr>
                        ...
                        <td style="width: 160px;font-size: 7pt;vertical-align: middle;">
                            <label>
                                <input type="radio" name="modalidad" checked value="0">
                                Todos
                            </label>
                            <label>
                                ...
                                <tr class="<?php echo $tr_class; ?>">
                                    ...
                                    <td class="">
                                        ...
                                        if ($nivel_administrador == '1') {
                                            ...
                                            $url_corta_personalizado = $curso['short_link'];
                                            ...
                                            echo '&nbsp;&nbsp;&nbsp;&nbsp;';
                                            echo "<i class='btn btn-warning active btn-xs' onclick='copyToClipboard(\"cureg".$curso['dr_id_curso']."\")' id='cureg".$curso['dr_id_curso']."'>".$url_corta_registro."</i>";

                                            if($curso['short_link']!=''){
                                                echo '&nbsp;&nbsp;&nbsp;&nbsp;';
                                                echo "<i class='btn btn-info active btn-xs' onclick='copyToClipboard(\"cursl".$curso['dr_id_curso']."\")' id='cursl".$curso['dr_id_curso']."'>".$url_corta_personalizado."</i>";
                                            }
                                        ...
                                        <?php if($curso['sw_view_home'] == '0'){ ?>
                                            <b class="btn btn-md btn-danger active">NO VISIBLE EN HOME</b>
                                        <?php } ?>
                                        <?php if($curso['sw_view_cat'] == '0'){ ?>
                                            <b class="btn btn-md btn-danger active">NO VISIBLE EN CATEGORIAS</b>
                                        <?php } ?>
...
<script>
    function buscar_curso() {
        ...
        let modalidad = $('input[name="modalidad"]:checked').val();
        $.ajax({
            url: '<?php echo $dominio_admin; ?>pages/ajax/ajax.inicio.buscar_curso.php',
            data: {dat: dat, modalidad: modalidad},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
                $("#AJAXCONTENT-buscar_participante").html(data);
