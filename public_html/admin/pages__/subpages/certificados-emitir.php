...
if (post('emitir-certificadoXXXX')) {
    ...
    $caracteristicas_paquete = str_replace('<li>', '<li style="list-style:none;"><img src="https://www.infosiscon.com/contenido/imagenes/images/icon-11.png"/> ', $rpq2['caracteristicas']);
...
<div class="row">
    <div class="col-mod-12">
        ...
        <h3 class="page-header"> Emisi&oacute;n de certificado <?php //echo $datos_empresa['nombre_empresa'];   ?><a href="https://www.infosiscon.com/empresas-listar/<?php echo $datos_empresa['clase']; ?>/todos/q=<?php echo $datos_empresa['correo_empresa']; ?>/vista/1.adm"><?php echo $datos_empresa['nombre_empresa']; ?></a> <i class="fa fa-info-circle animated bounceInDown show-info"></i> </h3>
