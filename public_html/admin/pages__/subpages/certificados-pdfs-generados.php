                        ...
                        while ($producto = fetch($resultado1)) {
                            ...
                            <tr>
                                ...
                                <td class="visible-lg" style="width:120px;">
                                    <a onclick="window.open('<?php echo $dominio_www; ?>contenido/archivos/pdfcursos/<?php echo $producto['dr_nombre_pdf']; ?>', 'popup', 'width=700,height=500');" style="cursor:pointer;"><i class='fa fa-file-pdf-o'></i> VISUALIZAR</a>
                                </td>
                            </tr>
                            <?php
                        }
