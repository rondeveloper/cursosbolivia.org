...
if (isset_post('agregar-banner')) {
  ...
  <strong>Error!</strong> no se selecciono ninguna imagen.
        ...
        move_uploaded_file(archivo($nom_img), $___path_raiz."contenido/imagenes/banners/$nombre_imagen");
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            while ($producto = fetch($resultado1)) {
                                ...
                                <tr>
                                    <td><?php echo $cnt--; ?></td>
                                    <td><img src="<?php echo $dominio_www; ?>contenido/imagenes/banners/<?php echo $producto['imagen']; ?>" style="height:50px;"/></td>
