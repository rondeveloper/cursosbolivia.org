...
<!--                                    <a hhref="capacitaciones/<?php echo $producto['titulo_identificador']; ?>.html" target="_blank"><i class='fa fa-eye'></i> Visualizar</a>
                                    ...
                                    /*
                                      ...
                                      ?>
                                      <br/>
                                      <a onclick="window.open('http://www.infosicoes.com/contenido/paginas/procesos/pdfs/certificado-2-pre-impresion.php?id_certificado=<?php echo $producto['id_certificado']; ?>', 'popup', 'width=700,height=500');" style="cursor:pointer;"><i class='fa fa-file-pdf-o'></i> Pre-Certificado</a>
                                      <?php
                                      }
                                     */
                                    ?>
...
<script>
    function duplicar_curso(id_curso, nombre_curso) {
        if (confirm('DUPLICACION DE CURSO - Desea duplicar el curso ' + nombre_curso+' ?')) {
            $.ajax({
                url: 'pages/ajax/ajax.capacitaciones-listar.duplicar_curso.php',
