...
if (isset_administrador()) {
    ...
    $total_registros = num_rows($resultado_reportes);
...
<style>
    ...
    <table>
        ...
        <tbody>
            ...
            while ($reporte = fetch($resultado_reportes)) {

                $r1 = query("SELECT * FROM empresas WHERE id=" . $reporte['id_empresa']) or die(mysqli_error($mysqli));
                $empresa = fetch($r1);
