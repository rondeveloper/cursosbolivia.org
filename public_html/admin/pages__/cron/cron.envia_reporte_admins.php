...
$asunto = 'LOGS DE MOVIMIENTO DE ADMINISTRADORES ['.$fecha_reporte.'] - '.$___nombre_del_sitio;

$content = '<h2>LOGS DE MOVIMIENTO DE ADMINISTRADORES ['.$fecha_reporte.'] - '.$___nombre_del_sitio.'</h2><hr/>';
