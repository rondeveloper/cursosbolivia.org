...
<script>
    function data_participantes(id_curso) {
        $.ajax({
            url: 'pages/ajax/ajax.cursos-cierres.data_participantes.php',
                        ...
                        <tbody>
                            ...
                            while ($curso = fetch($resultado1)) {
                                ...
                                <tr class="<?php echo $tr_class; ?>">
                                    ...
                                    <td class="visible-lgNOT">
                                        <table class="table table-bordered table-striped">
                                            ...
                                            while ($rqddc2 = fetch($rqddc1)) {
                                                ...
                                                echo "<td style='background:#FFF !important;'><a href='".$dominio."contenido/archivos/documentos/" . $rqddc2['nombre_archivo'] . "' target='_blank'>" . $rqddc2['codigo'] . "</a></td>";
                                    ...
                                    <td class="visible-lgNOT">
                                        <?php
                                        $url_img_curso = "https://www.infosiscon.com/paginas/" . $curso['imagen'] . ".size=2.img";
