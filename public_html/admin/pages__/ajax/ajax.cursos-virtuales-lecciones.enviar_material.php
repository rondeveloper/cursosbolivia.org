...
$correo_a_enviar = 'brayan.desteco@gmail.com';
...
foreach ($array_correos_a_enviar as $correo_a_enviar) {
    envia_correo_material($correo_a_enviar,$subject,$body,$nombre_fisico_material,$nombre_material);
    $cnt_aux++;
}
...
function envia_correo_material($correo_a_enviar,$subject,$body,$nombre_fisico_material,$nombre_material){
    ...
    if(emailValido($correo_a_enviar)){
        ...
        echo "[$correo_a_enviar] correo incorrecto<br>";
    }
}
