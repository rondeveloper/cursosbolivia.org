...
if ($id_modo_pago != '0') {
    $qr_modo_pago = " AND r.id_modo_pago='$id_modo_pago' ";
}
if ($id_banco != '0') {
    $qr_banco = " AND r.id_banco='$id_banco' ";
}
...
$rq_fechas $rq_departamento_curso $rq_docente $rq_nombre $rq_pago $rq_modalidad $qr_gratuitos $qr_modo_pago $qr_banco 
...
LEFT JOIN modos_de_pago mp ON r.id_modo_pago=mp.id 
WHERE p.estado=1 AND c.estado IN (0,1,2) 
$rq_fechas $rq_departamento_participante $rq_docente $rq_nombre $rq_pago $rq_modalidad $qr_gratuitos $qr_curso_especifico $qr_modo_pago $qr_banco 
        ...
        <tbody>
            ...
            while ($producto = fetch($resultado1)) {
                ...
                <tr>
                    ...
                    <td>
                        <?php echo $producto['dr_titulo_curso']; ?> 
    ...
    <table class="table table-hover table-bordered table-striped">
        <thead>
            <tr>
                ...
                <?php } ?>
                <th style="font-size:10pt;">Modalidad</th>
                <th style="font-size:10pt;" colspan="3">Pago</th>
            </tr>
        </thead>
        <tbody>
            <?php
            ...
            while ($producto = fetch($resultado1)) {
                ...
                <tr>
                    ...
                    <?php if(!$_SW_info_reducido){ ?>
                    <td>
                        <?php echo $producto['dr_titulo_curso']; ?> <b class="pull-right">[ID: <?php echo $producto['dr_id_curso']; ?>]</b>
                    </td>
                    <?php } ?>
                    <td>
                        <?php 
