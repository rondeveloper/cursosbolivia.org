...
$contenido_correo .= "<center><a href='".$dominio."'><img style='background:#2fbb20;width:230px;padding:1px;border:1px solid gray;border-radius:5px;' src='".$dominio_www."contenido/alt/logotipo-v3.png'/></a></center>"
        . $htm;
