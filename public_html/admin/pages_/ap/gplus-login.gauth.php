...
require_once('../../../contenido/librerias/gplus-login/google-login-api.php');
...
if (isset($_GET['code'])) {
    try {
        ...
        if (isset_usuario() && (!isset($_SESSION['ask_login'])) && false ) {
            ...
            if (num_rows($rqd1) > 0 ) {
                ...
                header('Location: '.$dominio_admin);
                echo "<script>location.href='$dominio_admin';</script>";
                //echo "END B";exit;
            ...
            } elseif(!isset($_SESSION['ask_login']) && false) {
                /* usuario */
