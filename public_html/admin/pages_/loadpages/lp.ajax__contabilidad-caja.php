        ...
        <div class="row" style="padding: 10px 0px;">
            <div class="col-md-5">
                <b style="font-size: 15pt;color: #3283ca;">
                    CAJA <i class="fa fa-info-circle animated bounceInDown show-info"></i>
                </b>
            </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading">MODULO CAJA</div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input-group col-sm-12">
                                    ...
                                    <input type="date" name="fecha_inicio" value="2021-06-11" class="form-control" placeholder="Fecha de inicio..." />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="input-group col-sm-12">
...
<script>
    function listado() {
        ...
        $.ajax({
            url: 'pages/ajax/ajax.contabilidad-caja.listado.php',
            data: form,
            type: 'POST',
            dataType: 'html',
