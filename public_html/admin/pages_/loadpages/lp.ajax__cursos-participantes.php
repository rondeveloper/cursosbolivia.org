...
/* datos del curso */
$rqc1 = query("SELECT titulo,titulo_identificador,fecha,fecha2,fecha3,imagen,costo,costo2,costo3,sw_fecha2,sw_fecha3,costo_e,costo_e2,id_certificado,id_certificado_2,(select codigo from cursos_certificados where id_curso=c.id order by id asc limit 1 )codigo_certificado,inicio_numeracion,id_modalidad,c.horarios FROM cursos c WHERE id='$id_curso' ORDER BY id DESC limit 1 ");
$rqc2 = fetch($rqc1);
