...
$contenido_correo = platillaEmailUno($contenido_noticia,$data_nombre_noticia,'[REMM-CORREO]','[REMM-UNSUB]', 'Usuario');
...
switch ($modo_envio) {
    case 'usuariosreg':
        ...
        while ($rqturap2 = fetch($rqtur1)) {
            ...
            $contenido_correo = str_replace(array('[REMM-CORREO]','[REMM-UNSUB]'),array($correo,urlUnsubscribe($correo)),$contenido_correo);
            ...
            if((int)$rqder2['total']==0){
                ...
                enviar_email($correo, $asunto, $contenido_correo);
                $cnt_env++;
                if ($cnt_env == 1) {
