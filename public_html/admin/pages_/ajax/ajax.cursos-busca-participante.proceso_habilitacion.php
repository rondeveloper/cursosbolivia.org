    ...
    <div class="col-md-12">
        ...
        if ($id_modo_pago == '0') {
            ...
            if ($sw_pago_enviado == '0') {
                ...
                <b>Monto pagado:</b> &nbsp; <?php echo (int)$monto_de_pago; ?> BS.
                <br/>
                <b>Imagen del deposito:</b> &nbsp; <a href="<?php echo $dominio_www; ?>depositos/<?php echo $imagen_de_deposito; ?>.img" target="_blank"><?php echo $imagen_de_deposito; ?></a>
                <br/>
                <br/>
                <img src="<?php echo $dominio_www; ?>depositos/<?php echo $imagen_de_deposito; ?>.size=3.img" style="width:100%;border:1px solid #DDD;padding:1px;">
                <?php
            }
