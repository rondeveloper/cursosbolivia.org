                        ...
                        <div class="col-md-4 text-left" style="padding: 0px 2px;">
                            <select class="form-control" name="id_departamento">
                                ...
                                while($rqddp2 = fetch($rqddp1)){
                                    ?>
                                    <option value="<?php echo $rqddp2['id']; ?>" <?php echo $participante['id_departamento']==$rqddp2['id']?' selected="selected" ':'';?>><?php echo $rqddp2['nombre']; ?></option>
                                    <?php
                                }
                                ?>
                            </select>
