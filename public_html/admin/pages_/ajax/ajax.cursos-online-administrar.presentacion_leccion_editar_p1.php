...
<form id="formagregaleccion" method="post" enctype="multipart/form-data">
    <table class="table table-bordered table-striped">
        <tr>
            <td colspan="3"><img src="<?php echo $dominio_www; ?>contenido/imagenes/presentaciones/<?php echo $presentacion['imagen']; ?>" style="height:150px;"/></td>
        </tr>
        <tr>
            <td>Imagen:</td>
...
<script>
    $('#formagregaleccion').on('submit', function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: 'pages/ajax/ajax.cursos-online-administrar.presentacion_leccion_editar_p2.php',
            data: formData,
            cache: false,
            contentType: false,
            processData: false,
