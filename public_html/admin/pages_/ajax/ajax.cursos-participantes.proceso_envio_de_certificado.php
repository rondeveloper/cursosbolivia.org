...
if (num_rows($rqvenvp1) > 0) {
    $rqvenvp2 = fetch($rqvenvp1);
    ?>
    ...
    <div class="text-center">
        ...
        if (num_rows($rqdenvc1) > 0) {
            $rqdenvc2 = fetch($rqdenvc1);
...
<script>
    function proceso_envio_de_certificado_p2() {
        ...
        $.ajax({
            url: 'pages/ajax/ajax.cursos-participantes.proceso_envio_de_certificado_p2.php',
            data: form,
            type: 'POST',
            dataType: 'html',
...
<script>
    function proceso_envio_de_certificado_p3() {
        ...
        $.ajax({
            url: 'pages/ajax/ajax.cursos-participantes.proceso_envio_de_certificado_p3.php',
            data: form,
            type: 'POST',
            dataType: 'html',
            success: function(data) {
...
<script>
    function proceso_envio_de_certificado_p4() {
        ...
        $.ajax({
            url: 'pages/ajax/ajax.cursos-participantes.proceso_envio_de_certificado_p4.php',
            data: form,
            type: 'POST',
            dataType: 'html',
            success: function(data) {
