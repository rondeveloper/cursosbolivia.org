...
if (isset_post('titulo_msj')) {
    ...
    <br/>';
        ...
        /* datos de correo */
        $contenido_correo = platillaEmailUno($texto_principal, "Mensaje de la plataforma - " . $___nombre_del_sitio, $rqddu2['correo'], urlUnsubscribe($rqddu2['correo']), $nombre_usuario);
        ...
        if($sw_env_adm){
            ...
            SISTsendEmail("brayan.desteco@gmail.com", $asunto.' (copia para administrador)', $contenido_correo);
        }
