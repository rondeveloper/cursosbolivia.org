    ...
    <form id="form-pagoparticipante">
                        ...
                        ?>
                            ...
                            <tr>
                                <td colspan="3" id="RESPONSE-cont">
                                    <button type="submit" class="btn btn-sm btn-success btn-block"><i class="fa fa-plus"></i> REGISTRAR PAGO</b>
                                </td>
                            </tr>
                        <?php
                        }
        ...
        <div style="border: 1px solid #8cc2e6;">
            <table class="table table-bordered table-dtriped">
                ...
                if(num_rows($rqvp1)==0 && (!$sw_solo_info)){
                ?>
                <tr>
                    <td colspan="4" class="text-right">
                        <b class="btn btn-danger btn-xs pull-right" onclick="anular_pago();"><i class="fa fa-trash-o"></i> &nbsp; ANULAR PAGO</b>
                    </td>
                </tr>
                <?php
                }
