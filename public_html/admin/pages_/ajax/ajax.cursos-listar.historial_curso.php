...
/* registros */
$rqdl1 = query("SELECT *,(select nombre from administradores where id=cursos_log.id_usuario)administrador FROM cursos_log WHERE objeto='curso' AND id_objeto='$id_curso' ORDER BY id DESC ");
if (num_rows($rqdl1) == 0) {
