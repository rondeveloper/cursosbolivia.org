...
';
                    ...
                    <td class="simple-td text-center">
                        ...
                        ?>
                        <?php 
                        if ($sw_askfactura_curso=='1' && $_SW_pago_verificado && $sw_facturacion_modulos) {
...
<!--                                    <a onclick="enviar_material_digital();" class="btn btn-primary"> ENVIAR POR CORREO</a>-->
                    ...
                    <hr>
                    <b class="btn btn-default btn-block btn-sm" onclick="trasladar_participantes();"><i class="fa fa-send"></i> Trasladar participantes</b>
                </div>
            </div>
        </div>
    </div>
