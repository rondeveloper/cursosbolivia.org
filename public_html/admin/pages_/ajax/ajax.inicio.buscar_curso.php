...
if ($dat != '') {
    ...
    <div class="table-responsive">
        <table class="table table-bordered">
            ...
            <?php
            $rqdp1 = query("SELECT c.id,c.estado,c.titulo,c.fecha FROM cursos c WHERE estado IN (0,1,2) AND (c.titulo LIKE '%$dat%'  OR c.id LIKE '$dat')  ORDER BY c.fecha DESC, c.id DESC limit 10 ");
