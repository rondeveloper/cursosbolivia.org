...
if (isset_administrador() && isset_post('id_valor')) {
    ...
    if ($r1) {
        ...
        $numero_de_paquetes_asignados_previamente = num_rows($rqpap1);
        ...
        echo " " . $estado_muestra . " <img src='".$dominio_www."contenido/imagenes/images/bien.png' style='width:25px;'>  Estado Actualizado!";
    } else {
        echo "Error";
    }
} else {
