...
$rqc1 = query("SELECT estado,costo,costo2,costo3,costo_e,costo_e2,sw_fecha2,fecha2,sw_fecha3,fecha3 FROM cursos WHERE id='$id_curso' ORDER BY id DESC limit 1 ");
$rqc2 = fetch($rqc1);
    ...
    <div style="background: #f1f1f1;border: 1px solid #bdd69d;border-radius: 5px;margin-bottom: 7px;">
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <td colspan="2">
                    <select name="id_modo_pago" class="form-control" id="F-data_fpago" required="" onchange="selecciona_modo_pago(this.value);">
                        <?php
            ...
            <tr id="tr-montopago">
                ...
                <td colspan="2">
                    <input type="number" name="monto_pago" class="form-control" id="F-data_mpago" required="" value="<?php echo $costo_curso; ?>"/>
                </td>
            </tr>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data_json_parsed['estado'] === 1) {
                        ...
                        var F_data_mpago = $("#F-data_mpago").val();
                        var F_data_fpago = $("#F-data_fpago").val();
                        document.getElementById("FORM-registra-participante").reset();
                        $("#F-data_mpago").val(F_data_mpago);
                        $("#F-data_fpago").val(F_data_fpago);
                    }else{
