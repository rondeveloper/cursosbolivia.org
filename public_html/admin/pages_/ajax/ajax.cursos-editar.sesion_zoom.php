...
if (isset_post('sw_send_form')) {
    ...
    (id_curso, url, descripcion, reunion_id, codigo_acceso, fecha, estado) 
    VALUES 
    ('$id_curso','$url','$descripcion','$reunion_id','$codigo_acceso','$fecha','1')");
...
if (isset_post('sw_send_edit_form')) {
    ...
    id_curso='$id_curso', url='$url', descripcion='$descripcion', reunion_id='$reunion_id', codigo_acceso='$codigo_acceso', fecha='$fecha' 
    ...
    <form id="FORM-sesion_zoom" action="" method="post">
        <table class="table table-bordered table-hover">
            <tr>
                ...
                <td>
                    <textarea class="form-control myinput" name="descripcion" placeholder="Descripci&oacute;n de la reuni&oacute;n..." required="" autocomplete="off" style="height: 70px;"><?php echo $rqcsz2['descripcion']; ?></textarea>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input class="form-control myinput" type="time" name="hora" value="<?php echo date("H:i",strtotime($rqcsz2['hora'])); ?>" placeholder="hora..." required="" value="" autocomplete="off">
                </td>
            </tr>
        </table>
...
?>
    <form id="FORM-sesion_zoom" action="" method="post">
        <table class="table table-bordered table-hover">
            <tr>
                ...
                <td>
                    <textarea class="form-control myinput" name="descripcion" placeholder="Descripci&oacute;n de la reuni&oacute;n..." required="" autocomplete="off" style="height: 70px;"></textarea>
                </td>
            </tr>
            <tr>
                <td>
    ...
    $rqv1 = query("SELECT * FROM sesiones_zoom WHERE id_curso='$id_curso' LIMIT 1 ");
    if (num_rows($rqv1) == 0) {
    ?>
    ...
    ?>
        ...
        <b class="btn btn-xs btn-info" onclick="editar_sesion_zoom(<?php echo $rqv2['id']; ?>);">EDITAR DATOS</b>
        &nbsp;&nbsp;&nbsp;
        <b class="btn btn-xs btn-danger" onclick="eliminar_sesion_zoom(<?php echo $rqv2['id']; ?>);">ELIMINAR SESION</b>
<?php
    }
}
