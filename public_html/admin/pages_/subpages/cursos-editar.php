            ...
            <div class="panel-body">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body" id="ajaxcontent-enlace">
                        <?php
                        $rqde1 = query("SELECT e.enlace FROM rel_cursoenlace r INNER JOIN enlaces_cursos e ON r.id_enlace=e.id WHERE r.id_curso='$id_curso' ORDER BY r.id DESC limit 1 ");
                        if(num_rows($rqde1)>0){
                            $rqde2 = fetch($rqde1);
