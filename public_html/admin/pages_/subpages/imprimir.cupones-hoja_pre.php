                            ...
                            <div class="ticket" style="color:#044a7e;border:0px solid #AAA;padding:0px;height:auto;background-color:#FFF;">
                                <div class="none">
                                    <div class="col-tk1" style="width:40%;float:left;font-size: 7pt;text-align: center;">
                                        <img src="http://www.infosicoes.com/contenido/imagenes/images/logo_infosicoes.png" style="width:95%;"/>
                                    ...
                                    <div class="col-tk1" style="font-weight: bold;width:60%;float:left;font-size: 8.5pt;text-align: center;padding-top:20px;">
                                        <img src="http://www.infosicoes.com/contenido/imagenes/images/nemabol.jpg" style="width:60%;"/>
                                    </div>
                                    <div class="clear" style="clear:both;width:100%;height:0px;"></div>
                                    <div style='border:5px solid gray;width:75%;padding:20px;margin:50px auto;'>
                                        ...
                                        <div style="text-align: center;font-weight: bold;font-size:17pt;padding:5px 0px;color:red;">
                                            <?php echo $r2['codigo']; ?>
                                        </div>
                                        <br/>
                                        ...
                                        <div style="color:#000;font-weight: bold;text-align:center;padding:20px;font-size:14pt;">
                                            Oficina Central
                                            <br/>
