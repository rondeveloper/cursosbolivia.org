...
if (isset_post('agregar-certificado-adicional')) {
    ...
    if(strtotime($fecha_qr)>strtotime($fecha2_qr)){
        ...
        query("INSERT INTO cursos_certificados
            (id_curso, codigo, modelo, cont_titulo, cont_uno, cont_dos, cont_tres,texto_qr,fecha_qr,fecha2_qr,sw_solo_nombre,id_fondo_digital, estado) 
                VALUES 
            ('$id_curso','$codigo_certificado','1','$cont_titulo','$cont_uno','$cont_dos','$cont_tres','$texto_qr','$fecha_qr','$fecha2_qr','$sw_solo_nombre','$id_fondo_digital','1')");
...
if (isset_post('editar-curso')) {
    ...
    $id_DSCcuenta_bancaria = post('id_DSCcuenta_bancaria');
    ...
    query("UPDATE cursos SET 
              ...
              id_DSCcuenta_bancaria='$id_DSCcuenta_bancaria', 
    ...
    <div class="col-md-12">
        <div class="panel">
            ...
            <div class="panel-body">
                ...
                if ((strtotime($curso['fecha']) >= strtotime(date("Y-m-d"))) || $nivel_administrador=='1') {
                                    ...
                                    <table style="width:100%;" class="table table-striped">
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div class="col-md-3">
                                                    <select class="form-control form-cascade-control" name="id_DSCcuenta_bancaria">
                                                        <?php
                                                        $rqdcb1 = query("SELECT * FROM cuentas_de_banco WHERE sw_asignar='1' AND estado='1' ");
                                                        while ($rqdcb2 = fetch($rqdcb1)) {
                                                            $selected = '';
                                                            if ($curso['id_DSCcuenta_bancaria'] == $rqdcb2['id']) {
                                                                $selected = ' selected="selected" ';
                                                            }
                                                            ?>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        <?php
                                                        $url_img = $dominio_www."paginas/" . $curso['imagen'] . ".size=2.img";
                                                        ?>
                                                        <img src="<?php echo $url_img; ?>" style="height:35px;border:1px solid #AAA;border-radius:3px;padding:2px;"/>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        <?php
                                                        $url_img = $dominio_www."paginas/" . $curso['imagen2'] . ".size=2.img";
                                                        ?>
                                                        <img src="<?php echo $url_img; ?>" style="height:35px;border:1px solid #AAA;border-radius:3px;padding:2px;"/>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        <?php
                                                        $url_img = $dominio_www."paginas/" . $curso['imagen3'] . ".size=2.img";
                                                        ?>
                                                        <img src="<?php echo $url_img; ?>" style="height:35px;border:1px solid #AAA;border-radius:3px;padding:2px;"/>
                                                    </div>
                                                </div>
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="col-md-4 text-center">
                                                        <?php
                                                        $url_img = $dominio_www."paginas/" . $curso['imagen4'] . ".size=2.img";
                                                        ?>
                                                        <img src="<?php echo $url_img; ?>" style="height:35px;border:1px solid #AAA;border-radius:3px;padding:2px;"/>
                                                    </div>
                                                </div>
                                                                        ...
                                                                        <div id="collapse1" class="panel-collapse collapse in">
                                                                            <div class="panel-body">
                                                                                <table class="table table-striped table-bordered table-hover">
                                                                                    ...
                                                                                    <?php
                                                                                    $rqdtcb1 = query("SELECT * FROM cuentas_de_banco WHERE id='" . $curso['id_DSCcuenta_bancaria'] . "' ORDER BY id ASC ");
...
<div id="MODAL-asignar-cert-adicional" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">ASIGNACI&Oacute;N DE CERTIFICADO</h4>
            </div>
            <div class="modal-body">
                <?php
                ...
                <form action='' method='post' enctype="multipart/form-data">
                    <table class="table table-striped table-bordered">
                        <tr>
                            <td>
                                <span class="input-group-addon"><b>CERTIFICADO (TEXTO QR):</b></span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <span class="input-group-addon"><b>FECHA INICIO (Fecha 1 QR):</b></span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <span class="input-group-addon"><b>FECHA FINAL (Fecha 2 QR):</b></span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                <span class="input-group-addon"><b>FONDO DIGITAL :</b></span>
                            </td>
                            <td>
