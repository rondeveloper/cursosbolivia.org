...
$resultado1 = query("SELECT *,(select nombre from administradores where id=f.id_administrador limit 1)administrador FROM facturas_emisiones f WHERE estado='2' AND fecha_emision LIKE '2017-11-%' ORDER BY id DESC LIMIT $start,$registros_a_mostrar");
$resultado2 = query("SELECT id FROM facturas_emisiones WHERE estado='2' AND fecha_emision LIKE '2017-11-%' ");
...
<script>
    function enviar_factura(id) {
        ...
        $.ajax({
            url: 'pages/ajax/ajax.instant.enviar_factura.php?nro_factura='+id+'&email_a_enviar='+email,
            data: {id: id},
            type: 'POST',
            dataType: 'html',
            success: function(data) {
